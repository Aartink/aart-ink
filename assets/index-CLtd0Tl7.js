...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:mi,depthTest:!1,depthWrite:!1})}function au(){return new Kn({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:Yl(),fragmentShader:`
		...
		`,blending:mi,depthTest:!1,depthWrite:!1})}function ou(){return new Kn({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:Yl(),fragmentShader:`
...
`)}function S0(i,e){let t;switch(e){case Sd:t="Linear";break;case Ed:t="Reinhard";break;case Td:t="Cineon";break;case bd:t="ACESFilmic";break;case wd:t="AgX";break;case Rd:t="Neutral";break;case Ad:t="Custom";break;default:console.warn("THREE.WebGLProgram: Unsupported toneMapping:",e),t="Linear"}return"vec3 "+i+"( vec3 color ) { return "+t+"ToneMapping( color ); }"}const sa=new P;function E0(){We.getLuminanceCoefficients(sa);const i=sa.x.toFixed(4),e=sa.y.toFixed(4),t=sa.z.toFixed(4);return["float luminance( const in vec3 rgb ) {",`	const vec3 weights = vec3( ${i}, ${e}, ${t} );`,"	return dot( weights, rgb );","}"].join(`
`)}function T0(i){return[i.extensionClipCullDistance?"#extension GL_ANGLE_clip_cull_distance : require":"",i.extensionMultiDraw?"#extension GL_ANGLE_multi_draw : require":""].filter(ir).join(`
`)}function b0(i){const e=[];for(const t in i){const n=i[t];n!==!1&&e.push("#define "+t+" "+n)}return e.join(`
`)}function A0(i,e){const t={},n=i.getProgramParameter(e,i.ACTIVE_ATTRIBUTES);for(let s=0;s<n;s++){const r=i.getActiveAttrib(e,s),a=r.name;let o=1;r.type===i.FLOAT_MAT2&&(o=2),r.type===i.FLOAT_MAT3&&(o=3),r.type===i.FLOAT_MAT4&&(o=4),t[a]={type:r.type,location:i.getAttribLocation(e,a),locationSize:o}}return t}function ir(i){return i!==""}function vu(i,e){const t=e.numSpotLightShadows+e.numSpotLightMaps-e.numSpotLightShadowsWithMaps;return i.replace(/NUM_DIR_LIGHTS/g,e.numDirLights).replace(/NUM_SPOT_LIGHTS/g,e.numSpotLights).replace(/NUM_SPOT_LIGHT_MAPS/g,e.numSpotLightMaps).replace(/NUM_SPOT_LIGHT_COORDS/g,t).replace(/NUM_RECT_AREA_LIGHTS/g,e.numRectAreaLights).replace(/NUM_POINT_LIGHTS/g,e.numPointLights).replace(/NUM_HEMI_LIGHTS/g,e.numHemiLights).replace(/NUM_DIR_LIGHT_SHADOWS/g,e.numDirLightShadows).replace(/NUM_SPOT_LIGHT_SHADOWS_WITH_MAPS/g,e.numSpotLightShadowsWithMaps).replace(/NUM_SPOT_LIGHT_SHADOWS/g,e.numSpotLightShadows).replace(/NUM_POINT_LIGHT_SHADOWS/g,e.numPointLightShadows)}function xu(i,e){return i.replace(/NUM_CLIPPING_PLANES/g,e.numClippingPlanes).replace(/UNION_CLIPPING_PLANES/g,e.numClippingPlanes-e.numClipIntersection)}const w0=/^[ \t]*#include +<([\w\d./]+)>/gm;function pl(i){return i.replace(w0,C0)}const R0=new Map;function C0(i,e){let t=Fe[e];if(t===void 0){const n=R0.get(e);if(n!==void 0)t=Fe[n],console.warn('THREE.WebGLRenderer: Shader chunk "%s" has been deprecated. Use "%s" instead.',e,n);else throw new Error("Can not resolve #include <"+e+">")}return pl(t)}const P0=/#pragma unroll_loop_start\s+for\s*\(\s*int\s+i\s*=\s*(\d+)\s*;\s*i\s*<\s*(\d+)\s*;\s*i\s*\+\+\s*\)\s*{([\s\S]+?)}\s+#pragma unroll_loop_end/g;function yu(i){return i.replace(P0,L0)}function L0(i,e,t,n){let s="";for(let r=parseInt(e);r<parseInt(t);r++)s+=n.replace(/\[\s*i\s*\]/g,"[ "+r+" ]").replace(/UNROLLED_LOOP_INDEX/g,r);return s}function Mu(i){let e=`precision ${i.precision} float;
...
#define LOW_PRECISION`),e}function D0(i){let e="SHADOWMAP_TYPE_BASIC";return i.shadowMapType===Hu?e="SHADOWMAP_TYPE_PCF":i.shadowMapType===td?e="SHADOWMAP_TYPE_PCF_SOFT":i.shadowMapType===kn&&(e="SHADOWMAP_TYPE_VSM"),e}function I0(i){let e="ENVMAP_TYPE_CUBE";if(i.envMap)switch(i.envMapMode){case Cs:case Ps:e="ENVMAP_TYPE_CUBE";break;case wa:e="ENVMAP_TYPE_CUBE_UV";break}return e}function U0(i){let e="ENVMAP_MODE_REFLECTION";if(i.envMap)switch(i.envMapMode){case Ps:e="ENVMAP_MODE_REFRACTION";break}return e}function N0(i){let e="ENVMAP_BLENDING_NONE";if(i.envMap)switch(i.combine){case Vu:e="ENVMAP_BLENDING_MULTIPLY";break;case yd:e="ENVMAP_BLENDING_MIX";break;case Md:e="ENVMAP_BLENDING_ADD";break}return e}function F0(i){const e=i.envMapCubeUVHeight;if(e===null)return null;const t=Math.log2(e)-2,n=1/e;return{texelWidth:1/(3*Math.max(Math.pow(2,t),7*16)),texelHeight:n,maxMip:t}}function O0(i,e,t,n){const s=i.getContext(),r=t.defines;let a=t.vertexShader,o=t.fragmentShader;const l=D0(t),c=I0(t),u=U0(t),h=N0(t),d=F0(t),p=T0(t),g=b0(r),_=s.createProgram();let m,f,E=t.glslVersion?"#version "+t.glslVersion+`
...
`].filter(ir).join(`
`)),a=pl(a),a=vu(a,t),a=xu(a,t),o=pl(o),o=vu(o,t),o=xu(o,t),a=yu(a),o=yu(o),t.isRawShaderMaterial!==!0&&(E=`#version 300 es
...
`)+`
`+f);const T=E+m+a,M=E+f+o,D=mu(s,s.VERTEX_SHADER,T),R=mu(s,s.FRAGMENT_SHADER,M);s.attachShader(_,D),s.attachShader(_,R),t.index0AttributeName!==void 0?s.bindAttribLocation(_,0,t.index0AttributeName):t.morphTargets===!0&&s.bindAttribLocation(_,0,"position"),s.linkProgram(_);function w(C){if(i.debug.checkShaderErrors){const V=s.getProgramInfoLog(_).trim(),I=s.getShaderInfoLog(D).trim(),O=s.getShaderInfoLog(R).trim();let G=!0,z=!0;if(s.getProgramParameter(_,s.LINK_STATUS)===!1)if(G=!1,typeof i.debug.onShaderError=="function")i.debug.onShaderError(s,_,D,R);else{const j=_u(s,D,"vertex"),W=_u(s,R,"fragment");console.error("THREE.WebGLProgram: Shader Error "+s.getError()+" - VALIDATE_STATUS "+s.getProgramParameter(_,s.VALIDATE_STATUS)+`
...
`;continue}if((z=G.match(x))&&(O.gamma=parseFloat(z[1])),(z=G.match(C))&&(O.exposure=parseFloat(z[1])),(z=G.match(V))&&(O.valid|=2,O.format=z[1]),(z=G.match(I))&&(O.valid|=4,O.height=parseInt(z[1],10),O.width=parseInt(z[2],10)),O.valid&2&&O.valid&4)break}return O.valid&2||a(3,"missing format specifier"),O.valid&4||a(3,"missing image size specifier"),O},p=function(A,S,x){const C=S;if(C<8||C>32767||A[0]!==2||A[1]!==2||A[2]&128)return new Uint8Array(A);C!==(A[2]<<8|A[3])&&a(3,"wrong scanline width");const V=new Uint8Array(4*S*x);V.length||a(4,"unable to allocate buffer space");let I=0,O=0;const G=4*C,z=new Uint8Array(4),j=new Uint8Array(G);let W=x;for(;W>0&&O<A.byteLength;){O+4>A.byteLength&&a(1),z[0]=A[O++],z[1]=A[O++],z[2]=A[O++],z[3]=A[O++],(z[0]!=2||z[1]!=2||(z[2]<<8|z[3])!=C)&&a(3,"bad rgbe scanline format");let ee=0,ne;for(;ee<G&&O<A.byteLength;){ne=A[O++];const Ee=ne>128;if(Ee&&(ne-=128),(ne===0||ee+ne>G)&&a(3,"bad scanline data"),Ee){const ke=A[O++];for(let q=0;q<ne;q++)j[ee++]=ke}else j.set(A.subarray(O,O+ne),ee),ee+=ne,O+=ne}const ge=C;for(let Ee=0;Ee<ge;Ee++){let ke=0;V[I]=j[Ee+ke],ke+=C,V[I+1]=j[Ee+ke],ke+=C,V[I+2]=j[Ee+ke],ke+=C,V[I+3]=j[Ee+ke],I+=4}W--}return V},g=function(A,S,x,C){const V=A[S+3],I=Math.pow(2,V-128)/255;x[C+0]=A[S+0]*I,x[C+1]=A[S+1]*I,x[C+2]=A[S+2]*I,x[C+3]=1},_=function(A,S,x,C){const V=A[S+3],I=Math.pow(2,V-128)/255;x[C+0]=Fr.toHalfFloat(Math.min(A[S+0]*I,65504)),x[C+1]=Fr.toHalfFloat(Math.min(A[S+1]*I,65504)),x[C+2]=Fr.toHalfFloat(Math.min(A[S+2]*I,65504)),x[C+3]=Fr.toHalfFloat(1)},m=new Uint8Array(e);m.pos=0;const f=d(m),E=f.width,T=f.height,M=p(m.subarray(m.pos),E,T);let D,R,w;switch(this.type){case Kt:w=M.length/4;const A=new Float32Array(w*4);for(let x=0;x<w;x++)g(M,x*4,A,x*4);D=A,R=Kt;break;case Vn:w=M.length/4;const S=new Uint16Array(w*4);for(let x=0;x<w;x++)_(M,x*4,S,x*4);D=S,R=Vn;break;default:throw new Error("THREE.RGBELoader: Unsupported type: "+this.type)}return{width:E,height:T,data:D,header:f.string,gamma:f.gamma,exposure:f.exposure,type:R}}setDataType(e){return this.type=e,this}load(e,t,n,s){function r(a,o){switch(a.type){case Kt:case Vn:a.colorSpace=It,a.minFilter=ot,a.magFilter=ot,a.generateMipmaps=!1,a.flipY=!0;break}t&&t(a,o)}return super.load(e,r,n,s)}}function wu(i,e){if(e===Ld)return console.warn("THREE.BufferGeometryUtils.toTrianglesDrawMode(): Geometry already defined as triangles."),i;if(e===ll||e===Qu){let t=i.getIndex();if(t===null){const a=[],o=i.getAttribute("position");if(o!==void 0){for(let l=0;l<o.count;l++)a.push(l);i.setIndex(a),t=i.getIndex()}else return console.error("THREE.BufferGeometryUtils.toTrianglesDrawMode(): Undefined position attribute. Processing not possible."),i}const n=t.count-2,s=[];if(e===ll)for(let a=1;a<=n;a++)s.push(t.getX(0)),s.push(t.getX(a)),s.push(t.getX(a+1));else for(let a=0;a<n;a++)a%2===0?(s.push(t.getX(a)),s.push(t.getX(a+1)),s.push(t.getX(a+2))):(s.push(t.getX(a+2)),s.push(t.getX(a+1)),s.push(t.getX(a)));s.length/3!==n&&console.error("THREE.BufferGeometryUtils.toTrianglesDrawMode(): Unable to generate correct amount of triangles.");const r=i.clone();return r.setIndex(s),r.clearGroups(),r}else return console.error("THREE.BufferGeometryUtils.toTrianglesDrawMode(): Unknown draw mode:",e),i}class wv extends Yi{constructor(e){super(e),this.dracoLoader=null,this.ktx2Loader=null,this.meshoptDecoder=null,this.pluginCallbacks=[],this.register(function(t){return new Dv(t)}),this.register(function(t){return new Iv(t)}),this.register(function(t){return new Vv(t)}),this.register(function(t){return new Gv(t)}),this.register(function(t){return new Wv(t)}),this.register(function(t){return new Nv(t)}),this.register(function(t){return new Fv(t)}),this.register(function(t){return new Ov(t)}),this.register(function(t){return new Bv(t)}),this.register(function(t){return new Lv(t)}),this.register(function(t){return new kv(t)}),this.register(function(t){return new Uv(t)}),this.register(function(t){return new Hv(t)}),this.register(function(t){return new zv(t)}),this.register(function(t){return new Cv(t)}),this.register(function(t){return new Xv(t)}),this.register(function(t){return new qv(t)})}load(e,t,n,s){const r=this;let a;if(this.resourcePath!=="")a=this.resourcePath;else if(this.path!==""){const c=or.extractUrlBase(e);a=or.resolveURL(c,this.path)}else a=or.extractUrlBase(e);this.manager.itemStart(e);const o=function(c){s?s(c):console.error(c),r.manager.itemError(e),r.manager.itemEnd(e)},l=new Vl(this.manager);l.setPath(this.path),l.setResponseType("arraybuffer"),l.setRequestHeader(this.requestHeader),l.setWithCredentials(this.withCredentials),l.load(e,function(c){try{r.parse(c,a,function(u){t(u),r.manager.itemEnd(e)},o)}catch(u){o(u)}},n,o)}setDRACOLoader(e){return this.dracoLoader=e,this}setKTX2Loader(e){return this.ktx2Loader=e,this}setMeshoptDecoder(e){return this.meshoptDecoder=e,this}register(e){return this.pluginCallbacks.indexOf(e)===-1&&this.pluginCallbacks.push(e),this}unregister(e){return this.pluginCallbacks.indexOf(e)!==-1&&this.pluginCallbacks.splice(this.pluginCallbacks.indexOf(e),1),this}parse(e,t,n,s){let r;const a={},o={},l=new TextDecoder;if(typeof e=="string")r=JSON.parse(e);else if(e instanceof ArrayBuffer)if(l.decode(new Uint8Array(e,0,4))===bh){try{a[ze.KHR_BINARY_GLTF]=new Yv(e)}catch(h){s&&s(h);return}r=JSON.parse(a[ze.KHR_BINARY_GLTF].content)}else r=JSON.parse(l.decode(e));else r=e;if(r.asset===void 0||r.asset.version[0]<2){s&&s(new Error("THREE.GLTFLoader: Unsupported asset. glTF versions >=2.0 are supported."));return}const c=new ax(r,{path:t||this.resourcePath||"",crossOrigin:this.crossOrigin,requestHeader:this.requestHeader,manager:this.manager,ktx2Loader:this.ktx2Loader,meshoptDecoder:this.meshoptDecoder});c.fileLoader.setRequestHeader(this.requestHeader);for(let u=0;u<this.pluginCallbacks.length;u++){const h=this.pluginCallbacks[u](c);h.name||console.error("THREE.GLTFLoader: Invalid plugin found: missing name"),o[h.name]=h,a[h.name]=!0}if(r.extensionsUsed)for(let u=0;u<r.extensionsUsed.length;++u){const h=r.extensionsUsed[u],d=r.extensionsRequired||[];switch(h){case ze.KHR_MATERIALS_UNLIT:a[h]=new Pv;break;case ze.KHR_DRACO_MESH_COMPRESSION:a[h]=new jv(r,this.dracoLoader);break;case ze.KHR_TEXTURE_TRANSFORM:a[h]=new Kv;break;case ze.KHR_MESH_QUANTIZATION:a[h]=new Zv;break;default:d.indexOf(h)>=0&&o[h]===void 0&&console.warn('THREE.GLTFLoader: Unknown extension "'+h+'".')}}c.setExtensions(a),c.setPlugins(o),c.parse(n,s)}parseAsync(e,t){const n=this;return new Promise(function(s,r){n.parse(e,t,s,r)})}}function Rv(){let i={};return{get:function(e){return i[e]},add:function(e,t){i[e]=t},remove:function(e){delete i[e]},removeAll:function(){i={}}}}const ze={KHR_BINARY_GLTF:"KHR_binary_glTF",KHR_DRACO_MESH_COMPRESSION:"KHR_draco_mesh_compression",KHR_LIGHTS_PUNCTUAL:"KHR_lights_punctual",KHR_MATERIALS_CLEARCOAT:"KHR_materials_clearcoat",KHR_MATERIALS_DISPERSION:"KHR_materials_dispersion",KHR_MATERIALS_IOR:"KHR_materials_ior",KHR_MATERIALS_SHEEN:"KHR_materials_sheen",KHR_MATERIALS_SPECULAR:"KHR_materials_specular",KHR_MATERIALS_TRANSMISSION:"KHR_materials_transmission",KHR_MATERIALS_IRIDESCENCE:"KHR_materials_iridescence",KHR_MATERIALS_ANISOTROPY:"KHR_materials_anisotropy",KHR_MATERIALS_UNLIT:"KHR_materials_unlit",KHR_MATERIALS_VOLUME:"KHR_materials_volume",KHR_TEXTURE_BASISU:"KHR_texture_basisu",KHR_TEXTURE_TRANSFORM:"KHR_texture_transform",KHR_MESH_QUANTIZATION:"KHR_mesh_quantization",KHR_MATERIALS_EMISSIVE_STRENGTH:"KHR_materials_emissive_strength",EXT_MATERIALS_BUMP:"EXT_materials_bump",EXT_TEXTURE_WEBP:"EXT_texture_webp",EXT_TEXTURE_AVIF:"EXT_texture_avif",EXT_MESHOPT_COMPRESSION:"EXT_meshopt_compression",EXT_MESH_GPU_INSTANCING:"EXT_mesh_gpu_instancing"};class Cv{constructor(e){this.parser=e,this.name=ze.KHR_LIGHTS_PUNCTUAL,this.cache={refs:{},uses:{}}}_markDefs(){const e=this.parser,t=this.parser.json.nodes||[];for(let n=0,s=t.length;n<s;n++){const r=t[n];r.extensions&&r.extensions[this.name]&&r.extensions[this.name].light!==void 0&&e._addNodeRef(this.cache,r.extensions[this.name].light)}}_loadLight(e){const t=this.parser,n="light:"+e;let s=t.cache.get(n);if(s)return s;const r=t.json,l=((r.extensions&&r.extensions[this.name]||{}).lights||[])[e];let c;const u=new _e(16777215);l.color!==void 0&&u.setRGB(l.color[0],l.color[1],l.color[2],It);const h=l.range!==void 0?l.range:0;switch(l.type){case"directional":c=new vh(u),c.target.position.set(0,0,-1),c.add(c.target);break;case"point":c=new fp(u),c.distance=h;break;case"spot":c=new hp(u),c.distance=h,l.spot=l.spot||{},l.spot.innerConeAngle=l.spot.innerConeAngle!==void 0?l.spot.innerConeAngle:0,l.spot.outerConeAngle=l.spot.outerConeAngle!==void 0?l.spot.outerConeAngle:Math.PI/4,c.angle=l.spot.outerConeAngle,c.penumbra=1-l.spot.innerConeAngle/l.spot.outerConeAngle,c.target.position.set(0,0,-1),c.add(c.target);break;default:throw new Error("THREE.GLTFLoader: Unexpected light type: "+l.type)}return c.position.set(0,0,0),zn(c,l),l.intensity!==void 0&&(c.intensity=l.intensity),c.name=t.createUniqueName(l.name||"light_"+e),s=Promise.resolve(c),t.cache.add(n,s),s}getDependency(e,t){if(e==="light")return this._loadLight(t)}createNodeAttachment(e){const t=this,n=this.parser,r=n.json.nodes[e],o=(r.extensions&&r.extensions[this.name]||{}).light;return o===void 0?null:this._loadLight(o).then(function(l){return n._getNodeRef(t.cache,o,l)})}}class Pv{constructor(){this.name=ze.KHR_MATERIALS_UNLIT}getMaterialType(){return en}extendParams(e,t,n){const s=[];e.color=new _e(1,1,1),e.opacity=1;const r=t.pbrMetallicRoughness;if(r){if(Array.isArray(r.baseColorFactor)){const a=r.baseColorFactor;e.color.setRGB(a[0],a[1],a[2],It),e.opacity=a[3]}r.baseColorTexture!==void 0&&s.push(n.assignTexture(e,"map",r.baseColorTexture,Rt))}return Promise.all(s)}}class Lv{constructor(e){this.parser=e,this.name=ze.KHR_MATERIALS_EMISSIVE_STRENGTH}extendMaterialParams(e,t){const s=this.parser.json.materials[e];if(!s.extensions||!s.extensions[this.name])return Promise.resolve();const r=s.extensions[this.name].emissiveStrength;return r!==void 0&&(t.emissiveIntensity=r),Promise.resolve()}}class Dv{constructor(e){this.parser=e,this.name=ze.KHR_MATERIALS_CLEARCOAT}getMaterialType(e){const n=this.parser.json.materials[e];return!n.extensions||!n.extensions[this.name]?null:Ln}extendMaterialParams(e,t){const n=this.parser,s=n.json.materials[e];if(!s.extensions||!s.extensions[this.name])return Promise.resolve();const r=[],a=s.extensions[this.name];if(a.clearcoatFactor!==void 0&&(t.clearcoat=a.clearcoatFactor),a.clearcoatTexture!==void 0&&r.push(n.assignTexture(t,"clearcoatMap",a.clearcoatTexture)),a.clearcoatRoughnessFactor!==void 0&&(t.clearcoatRoughness=a.clearcoatRoughnessFactor),a.clearcoatRoughnessTexture!==void 0&&r.push(n.assignTexture(t,"clearcoatRoughnessMap",a.clearcoatRoughnessTexture)),a.clearcoatNormalTexture!==void 0&&(r.push(n.assignTexture(t,"clearcoatNormalMap",a.clearcoatNormalTexture)),a.clearcoatNormalTexture.scale!==void 0)){const o=a.clearcoatNormalTexture.scale;t.clearcoatNormalScale=new Re(o,o)}return Promise.all(r)}}class Iv{constructor(e){this.parser=e,this.name=ze.KHR_MATERIALS_DISPERSION}getMaterialType(e){const n=this.parser.json.materials[e];return!n.extensions||!n.extensions[this.name]?null:Ln}extendMaterialParams(e,t){const s=this.parser.json.materials[e];if(!s.extensions||!s.extensions[this.name])return Promise.resolve();const r=s.extensions[this.name];return t.dispersion=r.dispersion!==void 0?r.dispersion:0,Promise.resolve()}}class Uv{constructor(e){this.parser=e,this.name=ze.KHR_MATERIALS_IRIDESCENCE}getMaterialType(e){const n=this.parser.json.materials[e];return!n.extensions||!n.extensions[this.name]?null:Ln}extendMaterialParams(e,t){const n=this.parser,s=n.json.materials[e];if(!s.extensions||!s.extensions[this.name])return Promise.resolve();const r=[],a=s.extensions[this.name];return a.iridescenceFactor!==void 0&&(t.iridescence=a.iridescenceFactor),a.iridescenceTexture!==void 0&&r.push(n.assignTexture(t,"iridescenceMap",a.iridescenceTexture)),a.iridescenceIor!==void 0&&(t.iridescenceIOR=a.iridescenceIor),t.iridescenceThicknessRange===void 0&&(t.iridescenceThicknessRange=[100,400]),a.iridescenceThicknessMinimum!==void 0&&(t.iridescenceThicknessRange[0]=a.iridescenceThicknessMinimum),a.iridescenceThicknessMaximum!==void 0&&(t.iridescenceThicknessRange[1]=a.iridescenceThicknessMaximum),a.iridescenceThicknessTexture!==void 0&&r.push(n.assignTexture(t,"iridescenceThicknessMap",a.iridescenceThicknessTexture)),Promise.all(r)}}class Nv{constructor(e){this.parser=e,this.name=ze.KHR_MATERIALS_SHEEN}getMaterialType(e){const n=this.parser.json.materials[e];return!n.extensions||!n.extensions[this.name]?null:Ln}extendMaterialParams(e,t){const n=this.parser,s=n.json.materials[e];if(!s.extensions||!s.extensions[this.name])return Promise.resolve();const r=[];t.sheenColor=new _e(0,0,0),t.sheenRoughness=0,t.sheen=1;const a=s.extensions[this.name];if(a.sheenColorFactor!==void 0){const o=a.sheenColorFactor;t.sheenColor.setRGB(o[0],o[1],o[2],It)}return a.sheenRoughnessFactor!==void 0&&(t.sheenRoughness=a.sheenRoughnessFactor),a.sheenColorTexture!==void 0&&r.push(n.assignTexture(t,"sheenColorMap",a.sheenColorTexture,Rt)),a.sheenRoughnessTexture!==void 0&&r.push(n.assignTexture(t,"sheenRoughnessMap",a.sheenRoughnessTexture)),Promise.all(r)}}class Fv{constructor(e){this.parser=e,this.name=ze.KHR_MATERIALS_TRANSMISSION}getMaterialType(e){const n=this.parser.json.materials[e];return!n.extensions||!n.extensions[this.name]?null:Ln}extendMaterialParams(e,t){const n=this.parser,s=n.json.materials[e];if(!s.extensions||!s.extensions[this.name])return Promise.resolve();const r=[],a=s.extensions[this.name];return a.transmissionFactor!==void 0&&(t.transmission=a.transmissionFactor),a.transmissionTexture!==void 0&&r.push(n.assignTexture(t,"transmissionMap",a.transmissionTexture)),Promise.all(r)}}class Ov{constructor(e){this.parser=e,this.name=ze.KHR_MATERIALS_VOLUME}getMaterialType(e){const n=this.parser.json.materials[e];return!n.extensions||!n.extensions[this.name]?null:Ln}extendMaterialParams(e,t){const n=this.parser,s=n.json.materials[e];if(!s.extensions||!s.extensions[this.name])return Promise.resolve();const r=[],a=s.extensions[this.name];t.thickness=a.thicknessFactor!==void 0?a.thicknessFactor:0,a.thicknessTexture!==void 0&&r.push(n.assignTexture(t,"thicknessMap",a.thicknessTexture)),t.attenuationDistance=a.attenuationDistance||1/0;const o=a.attenuationColor||[1,1,1];return t.attenuationColor=new _e().setRGB(o[0],o[1],o[2],It),Promise.all(r)}}class Bv{constructor(e){this.parser=e,this.name=ze.KHR_MATERIALS_IOR}getMaterialType(e){const n=this.parser.json.materials[e];return!n.extensions||!n.extensions[this.name]?null:Ln}extendMaterialParams(e,t){const s=this.parser.json.materials[e];if(!s.extensions||!s.extensions[this.name])return Promise.resolve();const r=s.extensions[this.name];return t.ior=r.ior!==void 0?r.ior:1.5,Promise.resolve()}}class kv{constructor(e){this.parser=e,this.name=ze.KHR_MATERIALS_SPECULAR}getMaterialType(e){const n=this.parser.json.materials[e];return!n.extensions||!n.extensions[this.name]?null:Ln}extendMaterialParams(e,t){const n=this.parser,s=n.json.materials[e];if(!s.extensions||!s.extensions[this.name])return Promise.resolve();const r=[],a=s.extensions[this.name];t.specularIntensity=a.specularFactor!==void 0?a.specularFactor:1,a.specularTexture!==void 0&&r.push(n.assignTexture(t,"specularIntensityMap",a.specularTexture));const o=a.specularColorFactor||[1,1,1];return t.specularColor=new _e().setRGB(o[0],o[1],o[2],It),a.specularColorTexture!==void 0&&r.push(n.assignTexture(t,"specularColorMap",a.specularColorTexture,Rt)),Promise.all(r)}}class zv{constructor(e){this.parser=e,this.name=ze.EXT_MATERIALS_BUMP}getMaterialType(e){const n=this.parser.json.materials[e];return!n.extensions||!n.extensions[this.name]?null:Ln}extendMaterialParams(e,t){const n=this.parser,s=n.json.materials[e];if(!s.extensions||!s.extensions[this.name])return Promise.resolve();const r=[],a=s.extensions[this.name];return t.bumpScale=a.bumpFactor!==void 0?a.bumpFactor:1,a.bumpTexture!==void 0&&r.push(n.assignTexture(t,"bumpMap",a.bumpTexture)),Promise.all(r)}}class Hv{constructor(e){this.parser=e,this.name=ze.KHR_MATERIALS_ANISOTROPY}getMaterialType(e){const n=this.parser.json.materials[e];return!n.extensions||!n.extensions[this.name]?null:Ln}extendMaterialParams(e,t){const n=this.parser,s=n.json.materials[e];if(!s.extensions||!s.extensions[this.name])return Promise.resolve();const r=[],a=s.extensions[this.name];return a.anisotropyStrength!==void 0&&(t.anisotropy=a.anisotropyStrength),a.anisotropyRotation!==void 0&&(t.anisotropyRotation=a.anisotropyRotation),a.anisotropyTexture!==void 0&&r.push(n.assignTexture(t,"anisotropyMap",a.anisotropyTexture)),Promise.all(r)}}class Vv{constructor(e){this.parser=e,this.name=ze.KHR_TEXTURE_BASISU}loadTexture(e){const t=this.parser,n=t.json,s=n.textures[e];if(!s.extensions||!s.extensions[this.name])return null;const r=s.extensions[this.name],a=t.options.ktx2Loader;if(!a){if(n.extensionsRequired&&n.extensionsRequired.indexOf(this.name)>=0)throw new Error("THREE.GLTFLoader: setKTX2Loader must be called before loading KTX2 textures");return null}return t.loadTextureImage(e,r.source,a)}}class Gv{constructor(e){this.parser=e,this.name=ze.EXT_TEXTURE_WEBP,this.isSupported=null}loadTexture(e){const t=this.name,n=this.parser,s=n.json,r=s.textures[e];if(!r.extensions||!r.extensions[t])return null;const a=r.extensions[t],o=s.images[a.source];let l=n.textureLoader;if(o.uri){const c=n.options.manager.getHandler(o.uri);c!==null&&(l=c)}return this.detectSupport().then(function(c){if(c)return n.loadTextureImage(e,a.source,l);if(s.extensionsRequired&&s.extensionsRequired.indexOf(t)>=0)throw new Error("THREE.GLTFLoader: WebP required by asset but unsupported.");return n.loadTexture(e)})}detectSupport(){return this.isSupported||(this.isSupported=new Promise(function(e){const t=new Image;t.src="data:image/webp;base64,UklGRiIAAABXRUJQVlA4IBYAAAAwAQCdASoBAAEADsD+JaQAA3AAAAAA",t.onload=t.onerror=function(){e(t.height===1)}})),this.isSupported}}class Wv{constructor(e){this.parser=e,this.name=ze.EXT_TEXTURE_AVIF,this.isSupported=null}loadTexture(e){const t=this.name,n=this.parser,s=n.json,r=s.textures[e];if(!r.extensions||!r.extensions[t])return null;const a=r.extensions[t],o=s.images[a.source];let l=n.textureLoader;if(o.uri){const c=n.options.manager.getHandler(o.uri);c!==null&&(l=c)}return this.detectSupport().then(function(c){if(c)return n.loadTextureImage(e,a.source,l);if(s.extensionsRequired&&s.extensionsRequired.indexOf(t)>=0)throw new Error("THREE.GLTFLoader: AVIF required by asset but unsupported.");return n.loadTexture(e)})}detectSupport(){return this.isSupported||(this.isSupported=new Promise(function(e){const t=new Image;t.src="data:image/avif;base64,",t.onload=t.onerror=function(){e(t.height===1)}})),this.isSupported}}class Xv{constructor(e){this.name=ze.EXT_MESHOPT_COMPRESSION,this.parser=e}loadBufferView(e){const t=this.parser.json,n=t.bufferViews[e];if(n.extensions&&n.extensions[this.name]){const s=n.extensions[this.name],r=this.parser.getDependency("buffer",s.buffer),a=this.parser.options.meshoptDecoder;if(!a||!a.supported){if(t.extensionsRequired&&t.extensionsRequired.indexOf(this.name)>=0)throw new Error("THREE.GLTFLoader: setMeshoptDecoder must be called before loading compressed files");return null}return r.then(function(o){const l=s.byteOffset||0,c=s.byteLength||0,u=s.count,h=s.byteStride,d=new Uint8Array(o,l,c);return a.decodeGltfBufferAsync?a.decodeGltfBufferAsync(u,h,d,s.mode,s.filter).then(function(p){return p.buffer}):a.ready.then(function(){const p=new ArrayBuffer(u*h);return a.decodeGltfBuffer(new Uint8Array(p),u,h,d,s.mode,s.filter),p})})}else return null}}class qv{constructor(e){this.name=ze.EXT_MESH_GPU_INSTANCING,this.parser=e}createNodeMesh(e){const t=this.parser.json,n=t.nodes[e];if(!n.extensions||!n.extensions[this.name]||n.mesh===void 0)return null;const s=t.meshes[n.mesh];for(const c of s.primitives)if(c.mode!==on.TRIANGLES&&c.mode!==on.TRIANGLE_STRIP&&c.mode!==on.TRIANGLE_FAN&&c.mode!==void 0)return null;const a=n.extensions[this.name].attributes,o=[],l={};for(const c in a)o.push(this.parser.getDependency("accessor",a[c]).then(u=>(l[c]=u,l[c])));return o.length<1?null:(o.push(this.parser.createNodeMesh(e)),Promise.all(o).then(c=>{const u=c.pop(),h=u.isGroup?u.children:[u],d=c[0].count,p=[];for(const g of h){const _=new Le,m=new P,f=new yn,E=new P(1,1,1),T=new Vf(g.geometry,g.material,d);for(let M=0;M<d;M++)l.TRANSLATION&&m.fromBufferAttribute(l.TRANSLATION,M),l.ROTATION&&f.fromBufferAttribute(l.ROTATION,M),l.SCALE&&E.fromBufferAttribute(l.SCALE,M),T.setMatrixAt(M,_.compose(m,f,E));for(const M in l)if(M==="_COLOR_0"){const D=l[M];T.instanceColor=new ul(D.array,D.itemSize,D.normalized)}else M!=="TRANSLATION"&&M!=="ROTATION"&&M!=="SCALE"&&g.geometry.setAttribute(M,l[M]);pt.prototype.copy.call(T,g),this.parser.assignFinalMaterial(T),p.push(T)}return u.isGroup?(u.clear(),u.add(...p),u):p[0]}))}}const bh="glTF",er=12,Ru={JSON:1313821514,BIN:5130562};class Yv{constructor(e){this.name=ze.KHR_BINARY_GLTF,this.content=null,this.body=null;const t=new DataView(e,0,er),n=new TextDecoder;if(this.header={magic:n.decode(new Uint8Array(e.slice(0,4))),version:t.getUint32(4,!0),length:t.getUint32(8,!0)},this.header.magic!==bh)throw new Error("THREE.GLTFLoader: Unsupported glTF-Binary header.");if(this.header.version<2)throw new Error("THREE.GLTFLoader: Legacy binary file detected.");const s=this.header.length-er,r=new DataView(e,er);let a=0;for(;a<s;){const o=r.getUint32(a,!0);a+=4;const l=r.getUint32(a,!0);if(a+=4,l===Ru.JSON){const c=new Uint8Array(e,er+a,o);this.content=n.decode(c)}else if(l===Ru.BIN){const c=er+a;this.body=e.slice(c,c+o)}a+=o}if(this.content===null)throw new Error("THREE.GLTFLoader: JSON content not found.")}}class jv{constructor(e,t){if(!t)throw new Error("THREE.GLTFLoader: No DRACOLoader instance provided.");this.name=ze.KHR_DRACO_MESH_COMPRESSION,this.json=e,this.dracoLoader=t,this.dracoLoader.preload()}decodePrimitive(e,t){const n=this.json,s=this.dracoLoader,r=e.extensions[this.name].bufferView,a=e.extensions[this.name].attributes,o={},l={},c={};for(const u in a){const h=ml[u]||u.toLowerCase();o[h]=a[u]}for(const u in e.attributes){const h=ml[u]||u.toLowerCase();if(a[u]!==void 0){const d=n.accessors[e.attributes[u]],p=bs[d.componentType];c[h]=p.name,l[h]=d.normalized===!0}}return t.getDependency("bufferView",r).then(function(u){return new Promise(function(h,d){s.decodeDracoFile(u,function(p){for(const g in p.attributes){const _=p.attributes[g],m=l[g];m!==void 0&&(_.normalized=m)}h(p)},o,c,It,d)})})}}class Kv{constructor(){this.name=ze.KHR_TEXTURE_TRANSFORM}extendTexture(e,t){return(t.texCoord===void 0||t.texCoord===e.channel)&&t.offset===void 0&&t.rotation===void 0&&t.scale===void 0||(e=e.clone(),t.texCoord!==void 0&&(e.channel=t.texCoord),t.offset!==void 0&&e.offset.fromArray(t.offset),t.rotation!==void 0&&(e.rotation=t.rotation),t.scale!==void 0&&e.repeat.fromArray(t.scale),e.needsUpdate=!0),e}}class Zv{constructor(){this.name=ze.KHR_MESH_QUANTIZATION}}class Ah extends Sr{constructor(e,t,n,s){super(e,t,n,s)}copySampleValue_(e){const t=this.resultBuffer,n=this.sampleValues,s=this.valueSize,r=e*s*3+s;for(let a=0;a!==s;a++)t[a]=n[r+a];return t}interpolate_(e,t,n,s){const r=this.resultBuffer,a=this.sampleValues,o=this.valueSize,l=o*2,c=o*3,u=s-t,h=(n-t)/u,d=h*h,p=d*h,g=e*c,_=g-c,m=-2*p+3*d,f=p-d,E=1-m,T=f-d+h;for(let M=0;M!==o;M++){const D=a[_+M+o],R=a[_+M+l]*u,w=a[g+M+o],A=a[g+M]*u;r[M]=E*D+T*R+m*w+f*A}return r}}const $v=new yn;class Jv extends Ah{interpolate_(e,t,n,s){const r=super.interpolate_(e,t,n,s);return $v.fromArray(r).normalize().toArray(r),r}}const on={POINTS:0,LINES:1,LINE_LOOP:2,LINE_STRIP:3,TRIANGLES:4,TRIANGLE_STRIP:5,TRIANGLE_FAN:6},bs={5120:Int8Array,5121:Uint8Array,5122:Int16Array,5123:Uint16Array,5125:Uint32Array,5126:Float32Array},Cu={9728:Wt,9729:ot,9984:Wu,9985:ca,9986:nr,9987:Tn},Pu={33071:En,33648:xa,10497:ki},Mo={SCALAR:1,VEC2:2,VEC3:3,VEC4:4,MAT2:4,MAT3:9,MAT4:16},ml={POSITION:"position",NORMAL:"normal",TANGENT:"tangent",TEXCOORD_0:"uv",TEXCOORD_1:"uv1",TEXCOORD_2:"uv2",TEXCOORD_3:"uv3",COLOR_0:"color",WEIGHTS_0:"skinWeight",JOINTS_0:"skinIndex"},oi={scale:"scale",translation:"position",rotation:"quaternion",weights:"morphTargetInfluences"},Qv={CUBICSPLINE:void 0,LINEAR:pr,STEP:fr},So={OPAQUE:"OPAQUE",MASK:"MASK",BLEND:"BLEND"};function ex(i){return i.DefaultMaterial===void 0&&(i.DefaultMaterial=new qi({color:16777215,emissive:0,metalness:1,roughness:1,transparent:!1,depthTest:!0,side:Yn})),i.DefaultMaterial}function Ci(i,e,t){for(const n in t.extensions)i[n]===void 0&&(e.userData.gltfExtensions=e.userData.gltfExtensions||{},e.userData.gltfExtensions[n]=t.extensions[n])}function zn(i,e){e.extras!==void 0&&(typeof e.extras=="object"?Object.assign(i.userData,e.extras):console.warn("THREE.GLTFLoader: Ignoring primitive type .extras, "+e.extras))}function tx(i,e,t){let n=!1,s=!1,r=!1;for(let c=0,u=e.length;c<u;c++){const h=e[c];if(h.POSITION!==void 0&&(n=!0),h.NORMAL!==void 0&&(s=!0),h.COLOR_0!==void 0&&(r=!0),n&&s&&r)break}if(!n&&!s&&!r)return Promise.resolve(i);const a=[],o=[],l=[];for(let c=0,u=e.length;c<u;c++){const h=e[c];if(n){const d=h.POSITION!==void 0?t.getDependency("accessor",h.POSITION):i.attributes.position;a.push(d)}if(s){const d=h.NORMAL!==void 0?t.getDependency("accessor",h.NORMAL):i.attributes.normal;o.push(d)}if(r){const d=h.COLOR_0!==void 0?t.getDependency("accessor",h.COLOR_0):i.attributes.color;l.push(d)}}return Promise.all([Promise.all(a),Promise.all(o),Promise.all(l)]).then(function(c){const u=c[0],h=c[1],d=c[2];return n&&(i.morphAttributes.position=u),s&&(i.morphAttributes.normal=h),r&&(i.morphAttributes.color=d),i.morphTargetsRelative=!0,i})}function nx(i,e){if(i.updateMorphTargets(),e.weights!==void 0)for(let t=0,n=e.weights.length;t<n;t++)i.morphTargetInfluences[t]=e.weights[t];if(e.extras&&Array.isArray(e.extras.targetNames)){const t=e.extras.targetNames;if(i.morphTargetInfluences.length===t.length){i.morphTargetDictionary={};for(let n=0,s=t.length;n<s;n++)i.morphTargetDictionary[t[n]]=n}else console.warn("THREE.GLTFLoader: Invalid extras.targetNames length. Ignoring names.")}}function ix(i){let e;const t=i.extensions&&i.extensions[ze.KHR_DRACO_MESH_COMPRESSION];if(t?e="draco:"+t.bufferView+":"+t.indices+":"+Eo(t.attributes):e=i.indices+":"+Eo(i.attributes)+":"+i.mode,i.targets!==void 0)for(let n=0,s=i.targets.length;n<s;n++)e+=":"+Eo(i.targets[n]);return e}function Eo(i){let e="";const t=Object.keys(i).sort();for(let n=0,s=t.length;n<s;n++)e+=t[n]+":"+i[t[n]]+";";return e}function gl(i){switch(i){case Int8Array:return 1/127;case Uint8Array:return 1/255;case Int16Array:return 1/32767;case Uint16Array:return 1/65535;default:throw new Error("THREE.GLTFLoader: Unsupported normalized accessor component type.")}}function sx(i){return i.search(/\.jpe?g($|\?)/i)>0||i.search(/^data\:image\/jpeg/)===0?"image/jpeg":i.search(/\.webp($|\?)/i)>0||i.search(/^data\:image\/webp/)===0?"image/webp":i.search(/\.ktx2($|\?)/i)>0||i.search(/^data\:image\/ktx2/)===0?"image/ktx2":"image/png"}const rx=new Le;class ax{constructor(e={},t={}){this.json=e,this.extensions={},this.plugins={},this.options=t,this.cache=new Rv,this.associations=new Map,this.primitiveCache={},this.nodeCache={},this.meshCache={refs:{},uses:{}},this.cameraCache={refs:{},uses:{}},this.lightCache={refs:{},uses:{}},this.sourceCache={},this.textureCache={},this.nodeNamesUsed={};let n=!1,s=-1,r=!1,a=-1;if(typeof navigator<"u"){const o=navigator.userAgent;n=/^((?!chrome|android).)*safari/i.test(o)===!0;const l=o.match(/Version\/(\d+)/);s=n&&l?parseInt(l[1],10):-1,r=o.indexOf("Firefox")>-1,a=r?o.match(/Firefox\/([0-9]+)\./)[1]:-1}typeof createImageBitmap>"u"||n&&s<17||r&&a<98?this.textureLoader=new _h(this.options.manager):this.textureLoader=new gp(this.options.manager),this.textureLoader.setCrossOrigin(this.options.crossOrigin),this.textureLoader.setRequestHeader(this.options.requestHeader),this.fileLoader=new Vl(this.options.manager),this.fileLoader.setResponseType("arraybuffer"),this.options.crossOrigin==="use-credentials"&&this.fileLoader.setWithCredentials(!0)}setExtensions(e){this.extensions=e}setPlugins(e){this.plugins=e}parse(e,t){const n=this,s=this.json,r=this.extensions;this.cache.removeAll(),this.nodeCache={},this._invokeAll(function(a){return a._markDefs&&a._markDefs()}),Promise.all(this._invokeAll(function(a){return a.beforeRoot&&a.beforeRoot()})).then(function(){return Promise.all([n.getDependencies("scene"),n.getDependencies("animation"),n.getDependencies("camera")])}).then(function(a){const o={scene:a[0][s.scene||0],scenes:a[0],animations:a[1],cameras:a[2],asset:s.asset,parser:n,userData:{}};return Ci(r,o,s),zn(o,s),Promise.all(n._invokeAll(function(l){return l.afterRoot&&l.afterRoot(o)})).then(function(){for(const l of o.scenes)l.updateMatrixWorld();e(o)})}).catch(t)}_markDefs(){const e=this.json.nodes||[],t=this.json.skins||[],n=this.json.meshes||[];for(let s=0,r=t.length;s<r;s++){const a=t[s].joints;for(let o=0,l=a.length;o<l;o++)e[a[o]].isBone=!0}for(let s=0,r=e.length;s<r;s++){const a=e[s];a.mesh!==void 0&&(this._addNodeRef(this.meshCache,a.mesh),a.skin!==void 0&&(n[a.mesh].isSkinnedMesh=!0)),a.camera!==void 0&&this._addNodeRef(this.cameraCache,a.camera)}}_addNodeRef(e,t){t!==void 0&&(e.refs[t]===void 0&&(e.refs[t]=e.uses[t]=0),e.refs[t]++)}_getNodeRef(e,t,n){if(e.refs[t]<=1)return n;const s=n.clone(),r=(a,o)=>{const l=this.associations.get(a);l!=null&&this.associations.set(o,l);for(const[c,u]of a.children.entries())r(u,o.children[c])};return r(n,s),s.name+="_instance_"+e.uses[t]++,s}_invokeOne(e){const t=Object.values(this.plugins);t.push(this);for(let n=0;n<t.length;n++){const s=e(t[n]);if(s)return s}return null}_invokeAll(e){const t=Object.values(this.plugins);t.unshift(this);const n=[];for(let s=0;s<t.length;s++){const r=e(t[s]);r&&n.push(r)}return n}getDependency(e,t){const n=e+":"+t;let s=this.cache.get(n);if(!s){switch(e){case"scene":s=this.loadScene(t);break;case"node":s=this._invokeOne(function(r){return r.loadNode&&r.loadNode(t)});break;case"mesh":s=this._invokeOne(function(r){return r.loadMesh&&r.loadMesh(t)});break;case"accessor":s=this.loadAccessor(t);break;case"bufferView":s=this._invokeOne(function(r){return r.loadBufferView&&r.loadBufferView(t)});break;case"buffer":s=this.loadBuffer(t);break;case"material":s=this._invokeOne(function(r){return r.loadMaterial&&r.loadMaterial(t)});break;case"texture":s=this._invokeOne(function(r){return r.loadTexture&&r.loadTexture(t)});break;case"skin":s=this.loadSkin(t);break;case"animation":s=this._invokeOne(function(r){return r.loadAnimation&&r.loadAnimation(t)});break;case"camera":s=this.loadCamera(t);break;default:if(s=this._invokeOne(function(r){return r!=this&&r.getDependency&&r.getDependency(e,t)}),!s)throw new Error("Unknown type: "+e);break}this.cache.add(n,s)}return s}getDependencies(e){let t=this.cache.get(e);if(!t){const n=this,s=this.json[e+(e==="mesh"?"es":"s")]||[];t=Promise.all(s.map(function(r,a){return n.getDependency(e,a)})),this.cache.add(e,t)}return t}loadBuffer(e){const t=this.json.buffers[e],n=this.fileLoader;if(t.type&&t.type!=="arraybuffer")throw new Error("THREE.GLTFLoader: "+t.type+" buffer type is not supported.");if(t.uri===void 0&&e===0)return Promise.resolve(this.extensions[ze.KHR_BINARY_GLTF].body);const s=this.options;return new Promise(function(r,a){n.load(or.resolveURL(t.uri,s.path),r,void 0,function(){a(new Error('THREE.GLTFLoader: Failed to load buffer "'+t.uri+'".'))})})}loadBufferView(e){const t=this.json.bufferViews[e];return this.getDependency("buffer",t.buffer).then(function(n){const s=t.byteLength||0,r=t.byteOffset||0;return n.slice(r,r+s)})}loadAccessor(e){const t=this,n=this.json,s=this.json.accessors[e];if(s.bufferView===void 0&&s.sparse===void 0){const a=Mo[s.type],o=bs[s.componentType],l=s.normalized===!0,c=new o(s.count*a);return Promise.resolve(new Xt(c,a,l))}const r=[];return s.bufferView!==void 0?r.push(this.getDependency("bufferView",s.bufferView)):r.push(null),s.sparse!==void 0&&(r.push(this.getDependency("bufferView",s.sparse.indices.bufferView)),r.push(this.getDependency("bufferView",s.sparse.values.bufferView))),Promise.all(r).then(function(a){const o=a[0],l=Mo[s.type],c=bs[s.componentType],u=c.BYTES_PER_ELEMENT,h=u*l,d=s.byteOffset||0,p=s.bufferView!==void 0?n.bufferViews[s.bufferView].byteStride:void 0,g=s.normalized===!0;let _,m;if(p&&p!==h){const f=Math.floor(d/p),E="InterleavedBuffer:"+s.bufferView+":"+s.componentType+":"+f+":"+s.count;let T=t.cache.get(E);T||(_=new c(o,f*p,s.count*p/u),T=new Of(_,p/u),t.cache.add(E,T)),m=new Fl(T,l,d%p/u,g)}else o===null?_=new c(s.count*l):_=new c(o,d,s.count*l),m=new Xt(_,l,g);if(s.sparse!==void 0){const f=Mo.SCALAR,E=bs[s.sparse.indices.componentType],T=s.sparse.indices.byteOffset||0,M=s.sparse.values.byteOffset||0,D=new E(a[1],T,s.sparse.count*f),R=new c(a[2],M,s.sparse.count*l);o!==null&&(m=new Xt(m.array.slice(),m.itemSize,m.normalized)),m.normalized=!1;for(let w=0,A=D.length;w<A;w++){const S=D[w];if(m.setX(S,R[w*l]),l>=2&&m.setY(S,R[w*l+1]),l>=3&&m.setZ(S,R[w*l+2]),l>=4&&m.setW(S,R[w*l+3]),l>=5)throw new Error("THREE.GLTFLoader: Unsupported itemSize in sparse BufferAttribute.")}m.normalized=g}return m})}loadTexture(e){const t=this.json,n=this.options,r=t.textures[e].source,a=t.images[r];let o=this.textureLoader;if(a.uri){const l=n.manager.getHandler(a.uri);l!==null&&(o=l)}return this.loadTextureImage(e,r,o)}loadTextureImage(e,t,n){const s=this,r=this.json,a=r.textures[e],o=r.images[t],l=(o.uri||o.bufferView)+":"+a.sampler;if(this.textureCache[l])return this.textureCache[l];const c=this.loadImageSource(t,n).then(function(u){u.flipY=!1,u.name=a.name||o.name||"",u.name===""&&typeof o.uri=="string"&&o.uri.startsWith("data:image/")===!1&&(u.name=o.uri);const d=(r.samplers||{})[a.sampler]||{};return u.magFilter=Cu[d.magFilter]||ot,u.minFilter=Cu[d.minFilter]||Tn,u.wrapS=Pu[d.wrapS]||ki,u.wrapT=Pu[d.wrapT]||ki,u.generateMipmaps=!u.isCompressedTexture&&u.minFilter!==Wt&&u.minFilter!==ot,s.associations.set(u,{textures:e}),u}).catch(function(){return null});return this.textureCache[l]=c,c}loadImageSource(e,t){const n=this,s=this.json,r=this.options;if(this.sourceCache[e]!==void 0)return this.sourceCache[e].then(h=>h.clone());const a=s.images[e],o=self.URL||self.webkitURL;let l=a.uri||"",c=!1;if(a.bufferView!==void 0)l=n.getDependency("bufferView",a.bufferView).then(function(h){c=!0;const d=new Blob([h],{type:a.mimeType});return l=o.createObjectURL(d),l});else if(a.uri===void 0)throw new Error("THREE.GLTFLoader: Image "+e+" is missing URI and bufferView");const u=Promise.resolve(l).then(function(h){return new Promise(function(d,p){let g=d;t.isImageBitmapLoader===!0&&(g=function(_){const m=new St(_);m.needsUpdate=!0,d(m)}),t.load(or.resolveURL(h,r.path),g,void 0,p)})}).then(function(h){return c===!0&&o.revokeObjectURL(l),zn(h,a),h.userData.mimeType=a.mimeType||sx(a.uri),h}).catch(function(h){throw console.error("THREE.GLTFLoader: Couldn't load texture",l),h});return this.sourceCache[e]=u,u}assignTexture(e,t,n,s){const r=this;return this.getDependency("texture",n.index).then(function(a){if(!a)return null;if(n.texCoord!==void 0&&n.texCoord>0&&(a=a.clone(),a.channel=n.texCoord),r.extensions[ze.KHR_TEXTURE_TRANSFORM]){const o=n.extensions!==void 0?n.extensions[ze.KHR_TEXTURE_TRANSFORM]:void 0;if(o){const l=r.associations.get(a);a=r.extensions[ze.KHR_TEXTURE_TRANSFORM].extendTexture(a,o),r.associations.set(a,l)}}return s!==void 0&&(a.colorSpace=s),e[t]=a,a})}assignFinalMaterial(e){const t=e.geometry;let n=e.material;const s=t.attributes.tangent===void 0,r=t.attributes.color!==void 0,a=t.attributes.normal===void 0;if(e.isPoints){const o="PointsMaterial:"+n.uuid;let l=this.cache.get(o);l||(l=new dh,bn.prototype.copy.call(l,n),l.color.copy(n.color),l.map=n.map,l.sizeAttenuation=!1,this.cache.add(o,l)),n=l}else if(e.isLine){const o="LineBasicMaterial:"+n.uuid;let l=this.cache.get(o);l||(l=new zl,bn.prototype.copy.call(l,n),l.color.copy(n.color),l.map=n.map,this.cache.add(o,l)),n=l}if(s||r||a){let o="ClonedMaterial:"+n.uuid+":";s&&(o+="derivative-tangents:"),r&&(o+="vertex-colors:"),a&&(o+="flat-shading:");let l=this.cache.get(o);l||(l=n.clone(),r&&(l.vertexColors=!0),a&&(l.flatShading=!0),s&&(l.normalScale&&(l.normalScale.y*=-1),l.clearcoatNormalScale&&(l.clearcoatNormalScale.y*=-1)),this.cache.add(o,l),this.associations.set(l,this.associations.get(n))),n=l}e.material=n}getMaterialType(){return qi}loadMaterial(e){const t=this,n=this.json,s=this.extensions,r=n.materials[e];let a;const o={},l=r.extensions||{},c=[];if(l[ze.KHR_MATERIALS_UNLIT]){const h=s[ze.KHR_MATERIALS_UNLIT];a=h.getMaterialType(),c.push(h.extendParams(o,r,t))}else{const h=r.pbrMetallicRoughness||{};if(o.color=new _e(1,1,1),o.opacity=1,Array.isArray(h.baseColorFactor)){const d=h.baseColorFactor;o.color.setRGB(d[0],d[1],d[2],It),o.opacity=d[3]}h.baseColorTexture!==void 0&&c.push(t.assignTexture(o,"map",h.baseColorTexture,Rt)),o.metalness=h.metallicFactor!==void 0?h.metallicFactor:1,o.roughness=h.roughnessFactor!==void 0?h.roughnessFactor:1,h.metallicRoughnessTexture!==void 0&&(c.push(t.assignTexture(o,"metalnessMap",h.metallicRoughnessTexture)),c.push(t.assignTexture(o,"roughnessMap",h.metallicRoughnessTexture))),a=this._invokeOne(function(d){return d.getMaterialType&&d.getMaterialType(e)}),c.push(Promise.all(this._invokeAll(function(d){return d.extendMaterialParams&&d.extendMaterialParams(e,o)})))}r.doubleSided===!0&&(o.side=jt);const u=r.alphaMode||So.OPAQUE;if(u===So.BLEND?(o.transparent=!0,o.depthWrite=!1):(o.transparent=!1,u===So.MASK&&(o.alphaTest=r.alphaCutoff!==void 0?r.alphaCutoff:.5)),r.normalTexture!==void 0&&a!==en&&(c.push(t.assignTexture(o,"normalMap",r.normalTexture)),o.normalScale=new Re(1,1),r.normalTexture.scale!==void 0)){const h=r.normalTexture.scale;o.normalScale.set(h,h)}if(r.occlusionTexture!==void 0&&a!==en&&(c.push(t.assignTexture(o,"aoMap",r.occlusionTexture)),r.occlusionTexture.strength!==void 0&&(o.aoMapIntensity=r.occlusionTexture.strength)),r.emissiveFactor!==void 0&&a!==en){const h=r.emissiveFactor;o.emissive=new _e().setRGB(h[0],h[1],h[2],It)}return r.emissiveTexture!==void 0&&a!==en&&c.push(t.assignTexture(o,"emissiveMap",r.emissiveTexture,Rt)),Promise.all(c).then(function(){const h=new a(o);return r.name&&(h.name=r.name),zn(h,r),t.associations.set(h,{materials:e}),r.extensions&&Ci(s,h,r),h})}createUniqueName(e){const t=nt.sanitizeNodeName(e||"");return t in this.nodeNamesUsed?t+"_"+ ++this.nodeNamesUsed[t]:(this.nodeNamesUsed[t]=0,t)}loadGeometries(e){const t=this,n=this.extensions,s=this.primitiveCache;function r(o){return n[ze.KHR_DRACO_MESH_COMPRESSION].decodePrimitive(o,t).then(function(l){return Lu(l,o,t)})}const a=[];for(let o=0,l=e.length;o<l;o++){const c=e[o],u=ix(c),h=s[u];if(h)a.push(h.promise);else{let d;c.extensions&&c.extensions[ze.KHR_DRACO_MESH_COMPRESSION]?d=r(c):d=Lu(new hn,c,t),s[u]={primitive:c,promise:d},a.push(d)}}return Promise.all(a)}loadMesh(e){const t=this,n=this.json,s=this.extensions,r=n.meshes[e],a=r.primitives,o=[];for(let l=0,c=a.length;l<c;l++){const u=a[l].material===void 0?ex(this.cache):this.getDependency("material",a[l].material);o.push(u)}return o.push(t.loadGeometries(a)),Promise.all(o).then(function(l){const c=l.slice(0,l.length-1),u=l[l.length-1],h=[];for(let p=0,g=u.length;p<g;p++){const _=u[p],m=a[p];let f;const E=c[p];if(m.mode===on.TRIANGLES||m.mode===on.TRIANGLE_STRIP||m.mode===on.TRIANGLE_FAN||m.mode===void 0)f=r.isSkinnedMesh===!0?new kf(_,E):new ft(_,E),f.isSkinnedMesh===!0&&f.normalizeSkinWeights(),m.mode===on.TRIANGLE_STRIP?f.geometry=wu(f.geometry,Qu):m.mode===on.TRIANGLE_FAN&&(f.geometry=wu(f.geometry,ll));else if(m.mode===on.LINES)f=new hh(_,E);else if(m.mode===on.LINE_STRIP)f=new Hl(_,E);else if(m.mode===on.LINE_LOOP)f=new Xf(_,E);else if(m.mode===on.POINTS)f=new qf(_,E);else throw new Error("THREE.GLTFLoader: Primitive mode unsupported: "+m.mode);Object.keys(f.geometry.morphAttributes).length>0&&nx(f,r),f.name=t.createUniqueName(r.name||"mesh_"+e),zn(f,r),m.extensions&&Ci(s,f,m),t.assignFinalMaterial(f),h.push(f)}for(let p=0,g=h.length;p<g;p++)t.associations.set(h[p],{meshes:e,primitives:p});if(h.length===1)return r.extensions&&Ci(s,h[0],r),h[0];const d=new Wn;r.extensions&&Ci(s,d,r),t.associations.set(d,{meshes:e});for(let p=0,g=h.length;p<g;p++)d.add(h[p]);return d})}loadCamera(e){let t;const n=this.json.cameras[e],s=n[n.type];if(!s){console.warn("THREE.GLTFLoader: Missing camera parameters.");return}return n.type==="perspective"?t=new Ht(Be.radToDeg(s.yfov),s.aspectRatio||1,s.znear||1,s.zfar||2e6):n.type==="orthographic"&&(t=new Wl(-s.xmag,s.xmag,s.ymag,-s.ymag,s.znear,s.zfar)),n.name&&(t.name=this.createUniqueName(n.name)),zn(t,n),Promise.resolve(t)}loadSkin(e){const t=this.json.skins[e],n=[];for(let s=0,r=t.joints.length;s<r;s++)n.push(this._loadNodeShallow(t.joints[s]));return t.inverseBindMatrices!==void 0?n.push(this.getDependency("accessor",t.inverseBindMatrices)):n.push(null),Promise.all(n).then(function(s){const r=s.pop(),a=s,o=[],l=[];for(let c=0,u=a.length;c<u;c++){const h=a[c];if(h){o.push(h);const d=new Le;r!==null&&d.fromArray(r.array,c*16),l.push(d)}else console.warn('THREE.GLTFLoader: Joint "%s" could not be found.',t.joints[c])}return new Bl(o,l)})}loadAnimation(e){const t=this.json,n=this,s=t.animations[e],r=s.name?s.name:"animation_"+e,a=[],o=[],l=[],c=[],u=[];for(let h=0,d=s.channels.length;h<d;h++){const p=s.channels[h],g=s.samplers[p.sampler],_=p.target,m=_.node,f=s.parameters!==void 0?s.parameters[g.input]:g.input,E=s.parameters!==void 0?s.parameters[g.output]:g.output;_.node!==void 0&&(a.push(this.getDependency("node",m)),o.push(this.getDependency("accessor",f)),l.push(this.getDependency("accessor",E)),c.push(g),u.push(_))}return Promise.all([Promise.all(a),Promise.all(o),Promise.all(l),Promise.all(c),Promise.all(u)]).then(function(h){const d=h[0],p=h[1],g=h[2],_=h[3],m=h[4],f=[];for(let E=0,T=d.length;E<T;E++){const M=d[E],D=p[E],R=g[E],w=_[E],A=m[E];if(M===void 0)continue;M.updateMatrix&&M.updateMatrix();const S=n._createAnimationTracks(M,D,R,w,A);if(S)for(let x=0;x<S.length;x++)f.push(S[x])}return new ip(r,void 0,f)})}createNodeMesh(e){const t=this.json,n=this,s=t.nodes[e];return s.mesh===void 0?null:n.getDependency("mesh",s.mesh).then(function(r){const a=n._getNodeRef(n.meshCache,s.mesh,r);return s.weights!==void 0&&a.traverse(function(o){if(o.isMesh)for(let l=0,c=s.weights.length;l<c;l++)o.morphTargetInfluences[l]=s.weights[l]}),a})}loadNode(e){const t=this.json,n=this,s=t.nodes[e],r=n._loadNodeShallow(e),a=[],o=s.children||[];for(let c=0,u=o.length;c<u;c++)a.push(n.getDependency("node",o[c]));const l=s.skin===void 0?Promise.resolve(null):n.getDependency("skin",s.skin);return Promise.all([r,Promise.all(a),l]).then(function(c){const u=c[0],h=c[1],d=c[2];d!==null&&u.traverse(function(p){p.isSkinnedMesh&&p.bind(d,rx)});for(let p=0,g=h.length;p<g;p++)u.add(h[p]);return u})}_loadNodeShallow(e){const t=this.json,n=this.extensions,s=this;if(this.nodeCache[e]!==void 0)return this.nodeCache[e];const r=t.nodes[e],a=r.name?s.createUniqueName(r.name):"",o=[],l=s._invokeOne(function(c){return c.createNodeMesh&&c.createNodeMesh(e)});return l&&o.push(l),r.camera!==void 0&&o.push(s.getDependency("camera",r.camera).then(function(c){return s._getNodeRef(s.cameraCache,r.camera,c)})),s._invokeAll(function(c){return c.createNodeAttachment&&c.createNodeAttachment(e)}).forEach(function(c){o.push(c)}),this.nodeCache[e]=Promise.all(o).then(function(c){let u;if(r.isBone===!0?u=new uh:c.length>1?u=new Wn:c.length===1?u=c[0]:u=new pt,u!==c[0])for(let h=0,d=c.length;h<d;h++)u.add(c[h]);if(r.name&&(u.userData.name=r.name,u.name=a),zn(u,r),r.extensions&&Ci(n,u,r),r.matrix!==void 0){const h=new Le;h.fromArray(r.matrix),u.applyMatrix4(h)}else r.translation!==void 0&&u.position.fromArray(r.translation),r.rotation!==void 0&&u.quaternion.fromArray(r.rotation),r.scale!==void 0&&u.scale.fromArray(r.scale);return s.associations.has(u)||s.associations.set(u,{}),s.associations.get(u).nodes=e,u}),this.nodeCache[e]}loadScene(e){const t=this.extensions,n=this.json.scenes[e],s=this,r=new Wn;n.name&&(r.name=s.createUniqueName(n.name)),zn(r,n),n.extensions&&Ci(t,r,n);const a=n.nodes||[],o=[];for(let l=0,c=a.length;l<c;l++)o.push(s.getDependency("node",a[l]));return Promise.all(o).then(function(l){for(let u=0,h=l.length;u<h;u++)r.add(l[u]);const c=u=>{const h=new Map;for(const[d,p]of s.associations)(d instanceof bn||d instanceof St)&&h.set(d,p);return u.traverse(d=>{const p=s.associations.get(d);p!=null&&h.set(d,p)}),h};return s.associations=c(r),r})}_createAnimationTracks(e,t,n,s,r){const a=[],o=e.name?e.name:e.uuid,l=[];oi[r.path]===oi.weights?e.traverse(function(d){d.morphTargetInfluences&&l.push(d.name?d.name:d.uuid)}):l.push(o);let c;switch(oi[r.path]){case oi.weights:c=Is;break;case oi.rotation:c=Us;break;case oi.translation:case oi.scale:c=Ns;break;default:switch(n.itemSize){case 1:c=Is;break;case 2:case 3:default:c=Ns;break}break}const u=s.interpolation!==void 0?Qv[s.interpolation]:pr,h=this._getArrayFromAccessor(n);for(let d=0,p=l.length;d<p;d++){const g=new c(l[d]+"."+oi[r.path],t.array,h,u);s.interpolation==="CUBICSPLINE"&&this._createCubicSplineTrackInterpolant(g),a.push(g)}return a}_getArrayFromAccessor(e){let t=e.array;if(e.normalized){const n=gl(t.constructor),s=new Float32Array(t.length);for(let r=0,a=t.length;r<a;r++)s[r]=t[r]*n;t=s}return t}_createCubicSplineTrackInterpolant(e){e.createInterpolant=function(n){const s=this instanceof Us?Jv:Ah;return new s(this.times,this.values,this.getValueSize()/3,n)},e.createInterpolant.isInterpolantFactoryMethodGLTFCubicSpline=!0}}function ox(i,e,t){const n=e.attributes,s=new Cn;if(n.POSITION!==void 0){const o=t.json.accessors[n.POSITION],l=o.min,c=o.max;if(l!==void 0&&c!==void 0){if(s.set(new P(l[0],l[1],l[2]),new P(c[0],c[1],c[2])),o.normalized){const u=gl(bs[o.componentType]);s.min.multiplyScalar(u),s.max.multiplyScalar(u)}}else{console.warn("THREE.GLTFLoader: Missing min/max properties for accessor POSITION.");return}}else return;const r=e.targets;if(r!==void 0){const o=new P,l=new P;for(let c=0,u=r.length;c<u;c++){const h=r[c];if(h.POSITION!==void 0){const d=t.json.accessors[h.POSITION],p=d.min,g=d.max;if(p!==void 0&&g!==void 0){if(l.setX(Math.max(Math.abs(p[0]),Math.abs(g[0]))),l.setY(Math.max(Math.abs(p[1]),Math.abs(g[1]))),l.setZ(Math.max(Math.abs(p[2]),Math.abs(g[2]))),d.normalized){const _=gl(bs[d.componentType]);l.multiplyScalar(_)}o.max(l)}else console.warn("THREE.GLTFLoader: Missing min/max properties for accessor POSITION.")}}s.expandByVector(o)}i.boundingBox=s;const a=new Pn;s.getCenter(a.center),a.radius=s.min.distanceTo(s.max)/2,i.boundingSphere=a}function Lu(i,e,t){const n=e.attributes,s=[];function r(a,o){return t.getDependency("accessor",a).then(function(l){i.setAttribute(o,l)})}for(const a in n){const o=ml[a]||a.toLowerCase();o in i.attributes||s.push(r(n[a],o))}if(e.indices!==void 0&&!i.index){const a=t.getDependency("accessor",e.indices).then(function(o){i.setIndex(o)});s.push(a)}return We.workingColorSpace!==It&&"COLOR_0"in n&&console.warn(`THREE.GLTFLoader: Converting vertex colors from "srgb-linear" to "${We.workingColorSpace}" not supported.`),zn(i,e),ox(i,e,t),Promise.all(s).then(function(){return e.targets!==void 0?tx(i,e.targets,t):i})}const Ws=/Mobi|Android/i.test(navigator.userAgent);let li=null;const Ut=new Ff,lx=Ws?80:75,dt=new Ht(lx,window.innerWidth/window.innerHeight,.1,1e3);dt.lookAt(0,0,0);Ws?dt.position.set(0,10,350):dt.position.set(0,10,200);dt.layers.enable(1);const Vi=new hv({canvas:document.querySelector("#bg"),antialias:!0}),Bi=Vi.domElement;Vi.setPixelRatio(window.devicePixelRatio);Vi.setSize(Bi.clientWidth,Bi.clientHeight,!1);const wh=new fl(Vi);wh.compileEquirectangularShader();const Fs=new wp,As=new Re,ei=[],cx=300;let un=[],Du=0,Os=!1,La=!0,Di=0;const ux=setInterval(()=>{Di<100&&(Kl=!0,Di+=1+Math.random()*1.5,Di=Math.min(Di,100),document.querySelector(".loading-progress").style.width=`${Di}%`),Di>=100&&clearInterval(ux)},100);function hx(){const i=document.getElementById("loading-screen");i.classList.add("fade-out"),setTimeout(()=>{i.style.display="none",La=!1;const e=()=>{window.removeEventListener("click",e),window.removeEventListener("touchstart",e),Uh()};window.addEventListener("click",e,{once:!0}),window.addEventListener("touchstart",e,{once:!0}),dx()},1e3)}const Da=new gh;let Kl=!1;Da.onProgress=(i,e,t)=>{Kl=!0;const n=e/t*100;Di=n,document.querySelector(".loading-progress").style.width=`${n}%`};Da.onLoad=async()=>{const i=Kl?0:1e3;await Promise.all(Bx),setTimeout(()=>{hx()},i)};const Rh=new wv(Da);function dx(){const i=()=>{if(!Os){Os=!0,rt.load();try{new(window.AudioContext||window.webkitAudioContext)().resume()}catch{}rt.play().then(()=>{console.log("🎧 Ambient started via touch"),Jl(),setupVolumeUI()}).catch(e=>{console.warn("❌ Autoplay blocked:",e),alert("⚠️ Touch again to enable sound")}),window.removeEventListener("touchstart",i),window.removeEventListener("click",i)}};window.addEventListener("touchstart",i,{once:!0}),window.addEventListener("click",i,{once:!0})}let _l=!1;window.onYouTubeIframeAPIReady=()=>{_l=!0};let Er=null,Vt=null;const Ta=5;window.addEventListener("mousedown",i=>{Er=i.target,Vt={x:i.clientX,y:i.clientY}});window.addEventListener("touchstart",i=>{const e=i.touches[0];Er=i.target,Vt={x:e.clientX,y:e.clientY}});const ba=document.getElementById("fullscreen-toggle"),aa=ba.querySelector("i");function Ch(){document.fullscreenElement?document.exitFullscreen().then(()=>{aa.classList.remove("fa-compress"),aa.classList.add("fa-expand"),ba.title="Enter fullscreen"}):document.documentElement.requestFullscreen().then(()=>{aa.classList.remove("fa-expand"),aa.classList.add("fa-compress"),ba.title="Exit fullscreen"})}ba.addEventListener("click",i=>{i.stopPropagation(),Ch()});document.addEventListener("keydown",i=>{i.key.toLowerCase()==="f"&&!i.repeat&&Ch()});const hi=document.createElement("div");hi.className="tooltip";document.body.appendChild(hi);const To=document.querySelector(".modal-details");["scroll","touchmove","wheel"].forEach(i=>To==null?void 0:To.addEventListener(i,Bs));const Gi=document.createElement("div");Gi.className="idle-hint";Ws?Gi.innerHTML=`
      ...
      `;document.body.appendChild(Gi);Gi.style.zoom="1";let vl,Ph=!1,xl=!1;function Lh(){Gi.classList.add("visible"),Ph=!0,xl=!1,setTimeout(()=>{xl=!0},1e4)}function fx(){Gi.classList.remove("visible")}function Dh(){Ph&&xl&&(fx(),clearTimeout(vl),vl=setTimeout(Lh,3e4))}function px(){vl=setTimeout(Lh,4e3),["mousemove","keydown","mousedown","wheel","touchstart","touchmove"].forEach(e=>window.addEventListener(e,Dh,{passive:!0}))}window.addEventListener("load",px);function Ia(){const e=/Mobi|Android/i.test(navigator.userAgent)?1:window.devicePixelRatio||1;document.documentElement.style.setProperty("--zoom",e)}Ia();window.addEventListener("resize",Ia);window.addEventListener("load",Ia);window.addEventListener("DOMContentLoaded",Ia);console.log("Current zoom factor:",getComputedStyle(document.documentElement).getPropertyValue("--zoom"));const _i=document.createElement("div");_i.id="coord-display";_i.innerHTML="<span>●</span>";document.body.appendChild(_i);let sr=!1,yl="";_i.classList.add("dot-mode");_i.addEventListener("click",()=>{sr=!sr,_i.classList.toggle("dot-mode",!sr),setTimeout(()=>{_i.querySelector("span").textContent=sr?yl:"●"},100)});function mx(){const i=Math.round(dt.position.x),e=Math.round(dt.position.y),t=Math.round(dt.position.z);yl=`${i} ${e} ${t}`,sr&&(_i.querySelector("span").textContent=yl)}let Ih=.2,Zn=.2;const _a={ambient:new Audio("./floats.mp3")},rt=_a.ambient;rt.loop=!0;rt.volume=Zn;function Uh(){La||Os||(Os=!0,rt.play().then(()=>{console.log("🎧 Ambient music playing"),Jl();const i=document.querySelector(".volume-control"),e=document.getElementById("volume-slider");e.addEventListener("mousedown",t=>t.stopPropagation()),e.addEventListener("touchstart",t=>t.stopPropagation()),i.classList.add("appear"),i.classList.remove("low-opacity"),i.classList.remove("hover-ready"),i.classList.remove("volume-visible"),setTimeout(()=>{i.classList.remove("appear"),i.classList.add("hover-ready"),window.dispatchEvent(new Event("volumePulseFinished"))},14300),window.removeEventListener("click",Uh)}).catch(i=>{console.warn("Autoplay blocked:",i)}))}const xs=document.getElementById("volume-icon"),Aa=document.getElementById("volume-slider");let qn=!1;function Nh(i){Zn=i,Ih=i,rt&&!qn&&(rt.volume=i),Aa.value=i,Zl()}function Zl(){const i=xs.classList;i.remove("fa-volume-mute","fa-volume-off","fa-volume-down","fa-volume-up"),qn||Zn===0?(i.add("fa-volume-mute"),xs.style.color="#888"):Zn<.5?(i.add("fa-volume-down"),xs.style.color="#ffcc00"):(i.add("fa-volume-up"),xs.style.color="#ffcc00")}let oa=Zn;xs&&xs.addEventListener("click",()=>{qn=!qn,qn?(oa=rt.volume,rt.volume=0,Aa.value=0):(rt.volume=oa,Zn=oa,Aa.value=oa),Zl()});Aa.addEventListener("input",i=>{const e=parseFloat(i.target.value);qn&&(qn=!1,Zl()),Nh(e),rt.paused&&rt.play().then(()=>{console.log("🔊 Ambient resumed via volume slider")}).catch(t=>{console.warn("Could not resume ambient:",t)})});Nh(Zn);function Iu(i,e=300){const n=e/30,s=rt.volume,r=(i-s)/30;let a=0;const o=setInterval(()=>{a++;const l=s+r*a;rt.volume=Be.clamp(l,0,1),a>=30&&clearInterval(o)},n)}Iu(qn?0:Zn);const Dt=new fv(dt,Vi.domElement);Ws&&(Dt.enableZoom=!0,Dt.enablePan=!0,Dt.enableDamping=!0,Dt.dampingFactor=1,Dt.rotateSpeed=1,Dt.zoomSpeed=.5,Dt.panSpeed=1.5);Dt.minDistance=35;Dt.maxDistance=800;window.addEventListener("touchstart",i=>{const e=i.touches[0];Er=i.target,Vt={x:e.clientX,y:e.clientY};const t=Date.now();if(t-lastTap<400){i.preventDefault();return}lastTap=t},{passive:!1});window.addEventListener("touchend",i=>{const e=i.changedTouches[0],t={x:e.clientX,y:e.clientY},n=Math.abs(t.x-((Vt==null?void 0:Vt.x)??0)),s=Math.abs(t.y-((Vt==null?void 0:Vt.y)??0));if(n>Ta||s>Ta||Er!==i.target){console.log("❌ Touch drag blocked");return}const a=(Zt==null?void 0:Zt.style.display)==="flex",o=i.target.closest(".mic-popup-window"),l=i.target.closest(".modal-content"),c=i.target.closest(".modal-close");if(l||a&&!o)return;if(c)return gr();if(Ue.classList.contains("active"))return;const u=Bi.getBoundingClientRect(),h=(e.clientX-u.left)/Bi.clientWidth*2-1,d=-((e.clientY-u.top)/Bi.clientHeight)*2+1;As.set(h,d),Fs.setFromCamera(As,dt);const p=Fs.intersectObjects(ei,!0);for(const g of p)if(g.object.userData.isImagePlane){const{name:_,imageSrc:m,medium:f,year:E,description:T,isVideoPlane:M,ytVideoId:D,kiriEmbed:R}=g.object.userData;Bh({name:_,imageSrc:m,medium:f,year:E,description:T,isVideoPlane:M,ytVideoId:D,kiriEmbed:R});break}},{passive:!1});window.addEventListener("touchmove",Dh,{passive:!0});const gx="./HDR_blue_local_star_lowres.hdr",_x="./HDR_blue_local_star.hdr",vx=Ws?gx:_x;new Av(Da).load(vx,i=>{i.mapping=va;const e=wh.fromEquirectangular(i).texture;Ut.environment=e,Ut.background=e});const Tr=document.createElement("div");Tr.classList.add("overlay");document.body.appendChild(Tr);const Fh=document.createElement("style");Fh.innerHTML=`
    .overlay {
      position: fixed;
      top: 0;
      left: 0;
...
`;document.body.appendChild(Ue);Ue.querySelector(".modal-close");const Pi=Ue.querySelector(".modal-image"),Ot=Ue.querySelector(".modal-embed"),us=Ue.querySelector(".modal-title"),hs=Ue.querySelector(".modal-medium .value"),ds=Ue.querySelector(".modal-year .value"),fs=Ue.querySelector(".modal-description .value");function xx(i){const e=i.domElement,t=e.clientWidth,n=e.clientHeight,s=window.devicePixelRatio||1,r=e.width!==t*s||e.height!==n*s;return r&&(i.setSize(t,n,!1),i.setPixelRatio(s)),r}function Uu(i,e=2e3){let t=1;i.setVolume(t);const n=100/(e/50),s=setInterval(()=>{t+=n,t>=100?(i.setVolume(100),clearInterval(s)):i.setVolume(t)},50)}function Oh(i,e=1500){var r;let t=((r=i.getVolume)==null?void 0:r.call(i))??100;const n=t/(e/50),s=setInterval(()=>{t-=n,t<=0?(i.setVolume(0),i.pauseVideo(),clearInterval(s)):i.setVolume(t)},50)}function Bh({name:i,imageSrc:e,medium:t,year:n,description:s,isVideoPlane:r,ytVideoId:a,kiriEmbed:o}){const l=Ue.querySelector(".modal-content"),c=i==="aart.ink",u=i==="Bisque Pot",h=i==="3D Scan";if(Ue.classList.contains("active")||history.pushState({modalOpen:!0},""),Ue.classList.add("active"),Tr.style.display="block",document.body.style.overflow="hidden",Dt.enabled=!1,Ue.style.zIndex=9999,Pi.src="",Pi.alt="",Pi.style.display="none",Ot.innerHTML="",Ot.style.display="none",l.classList.remove("aartink-mode"),Ue.removeAttribute("data-aartink"),rt&&!rt.paused&&r&&(rt.pause(),console.log("🎞 Ambient music paused for video")),c)l.classList.add("aartink-mode"),Ue.setAttribute("data-aartink","true"),us.textContent="aart.ink",hs.textContent="",ds.textContent="",fs.innerHTML=`
  ...
  `,setTimeout(()=>{const p=document.getElementById("send-email-btn"),g=document.getElementById("user-email"),_=document.getElementById("email-status");!p||!g||!_||p.addEventListener("click",()=>{const m=g.value.trim();if(!m||!/^[^\s@]+@[^\s@]+\.[^\s@]+$/.test(m)){_.textContent="❗ Please enter a valid email.",_.style.color="red";return}fetch("https://aartink.netlify.app/.netlify/functions/send-newsletter",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({email:m})}).then(E=>E.json()).then(E=>{E.success?(_.textContent="✅ Welcome email sent!",_.style.color="green",g.value=""):(_.textContent="❌ Failed to send. Try again.",_.style.color="red")}).catch(E=>{_.textContent="❌ Error sending email.",_.style.color="red",console.error(E)})})},100);else if(o)Ot.innerHTML=o,Ot.style.display="block",Pi.style.display="none",us.textContent=i||"",hs.textContent=t||"",ds.textContent=n||"",fs.innerHTML=s||"";else if(u)Ot.innerHTML=`
      ...
      `,Ot.style.display="block",us.textContent=i||"",hs.textContent=t||"",ds.textContent=n||"",fs.innerHTML=s||"";else if(r){const p=a||"defaultVideoId",g=/Mobi|Android/i.test(navigator.userAgent);if(Ot.innerHTML="",g&&_l){const _=document.createElement("div");_.id="yt-mobile-player",_.style.width="100%",_.style.maxWidth="2400px",_.style.aspectRatio="16 / 9",_.style.marginBottom="1rem",Ot.appendChild(_);const m=document.createElement("button");m.className="unmute-btn",m.innerText="🔊 Watch with Sound",Object.assign(m.style,{marginTop:"1rem",padding:"10px 20px",fontSize:"1rem",background:"yellow",color:"black",border:"none",cursor:"pointer",borderRadius:"10px",textAlign:"left",display:"inline-block"}),Ot.appendChild(m),ytMobilePlayer=new YT.Player("yt-mobile-player",{videoId:p,playerVars:{autoplay:1,mute:0,playsinline:1},events:{onReady:f=>{f.target.unMute(),f.target.playVideo(),Uu(f.target),Ue.dataset.ytPlayer=f.target}}})}else if(_l){const _=document.createElement("div");_.id="yt-desktop-player",_.style.width="100%",_.style.maxWidth="2400px",_.style.aspectRatio="16 / 9",_.style.marginBottom="1rem",Ot.appendChild(_);const m=new YT.Player("yt-desktop-player",{videoId:p,playerVars:{autoplay:1,mute:0,playsinline:1},events:{onReady:f=>{f.target.unMute(),f.target.playVideo(),Uu(f.target),Ue.dataset.ytPlayer=f.target}}});Ue.dataset.ytPlayer=m}else{const _=`https://www.youtube.com/embed/${p}?autoplay=1&mute=0&playsinline=1&enablejsapi=1&rel=0&showinfo=0`;Ot.innerHTML=`
          <iframe 
            id="yt-player"
            title="${i}" 
            src="${_}" 
        ...
        `}Ot.style.display="block",us.textContent=i||"",hs.textContent=t||"",ds.textContent=n||"",fs.innerHTML=s||""}else Pi.src=e||"",Pi.alt=i||"",Pi.style.display="block",us.textContent=i||"",hs.textContent=t||"",ds.textContent=n||"",fs.innerHTML=s||"";setTimeout(Bs,100);const d=Ue.querySelector(".modal-details");d&&new ResizeObserver(Bs).observe(d)}function gr(){Ue.classList.add("closing"),setTimeout(()=>{Ue.classList.remove("active","closing"),document.body.style.overflow="",Dt.enabled=!0,Tr.style.display="none";const i=Ue.querySelector(".modal-content"),e=Ue.querySelector(".modal-details");if(i&&(i.style.transform=""),e&&(e.style.transform=""),rt&&!qn){rt.paused&&(rt.volume=0,rt.play().then(()=>{console.log("🔊 Ambient resumed after modal close")}).catch(a=>{console.warn("Ambient resume failed:",a)}));const n=Zn||.4,s=n/20,r=setInterval(()=>{rt.volume=Math.min(n,rt.volume+s),rt.volume>=n&&clearInterval(r)},50)}if(Ue.dataset.ytPlayer){const n=Ue.dataset.ytPlayer;Oh(n),Ue.dataset.ytPlayer=null}Ue.querySelectorAll("iframe").forEach(n=>n.remove()),Ot.innerHTML="",history.state&&history.state.modalOpen&&history.back()},400)}Ue.classList.add("closing");setTimeout(()=>{Ue.classList.remove("active","closing"),document.body.style.overflow="",Dt.enabled=!0,Tr.style.display="none";const i=Ue.querySelector(".modal-content"),e=Ue.querySelector(".modal-details");i&&(i.style.transform=""),e&&(e.style.transform="")},400);history.state&&history.state.modalOpen&&history.back();_a&&!_a.muted&&(_a.volume=Ih);if(Ue.dataset.ytPlayer){const i=Ue.dataset.ytPlayer;Oh(i),Ue.dataset.ytPlayer=null}document.addEventListener("keydown",i=>{i.key==="Escape"&&Ue.classList.contains("active")&&gr()});window.addEventListener("popstate",i=>{Ue.classList.contains("active")&&gr()});function yx(i,e){i.userData={...e,...i.userData},i.isMesh&&(i.userData.cachedOutline=null),i.traverse(t=>{t.isMesh&&(t.userData={...e,...t.userData},t.userData.cachedOutline=null)})}const $n=document.createElement("video");$n.src="./test.mp4";$n.loop=!0;$n.muted=!0;$n.autoplay=!0;$n.oncanplaythrough=()=>$n.play();const kh=new Ra($n),Mx=new en({map:kh,color:new _e(16777215)}),xt=new ft(new Xi(30,72,72),Mx);Ut.add(xt);xt.userData={isImagePlane:!0,name:"C.O.L.L.A.B",imageSrc:"./Sphere.jpg",description:"C.O.L.L.A.B explores the concept of translations: from sound to image, from the physical to the metaphysical. At its core, the project investigates the dynamic relationship between humans, technology, and space through interactive sound and projected visuals. The central sphere acts as both a canvas and living entity, responding to your presence. Visuals emerge from the sphere’s surface, shaped by the volume and frequency of its surrounding sounds.",medium:"Installation",year:"2025"};ei.push(xt);const Sx=new _h,xi=[],br=[];un.push(...br);const Jn=document.createElement("video");Jn.src="./Shaped.mp4";Jn.loop=!0;Jn.muted=!0;Jn.autoplay=!0;Jn.playsInline=!0;Jn.oncanplaythrough=()=>Jn.play();const Ua=new Ra(Jn);Ua.minFilter=ot;Ua.magFilter=ot;Ua.format=Mr;const zh=new en({map:Ua,side:jt}),Ex=new vi(65,40),wn=new ft(Ex,zh);wn.position.set(-40,-80,100);wn.userData.originalColor=zh.color.clone();wn.userData={isImagePlane:!0,isVideoPlane:!0,name:"Shaped",imageSrc:"",description:"Thomas was alone, Thomas went on a journey, Thomas was shaped, Thomas is home.",medium:"Stop-motion painting",year:"2021"};Ut.add(wn);ei.push(wn);wn.userData.baseScale=wn.scale.clone();br.push(wn);wn.userData.ytVideoId="l7PrLzz6X3Q";const Qn=document.createElement("video");Qn.src="./NothingChanges.mp4";Qn.loop=!0;Qn.muted=!0;Qn.autoplay=!0;Qn.playsInline=!0;Qn.oncanplaythrough=()=>Qn.play();const Na=new Ra(Qn);Na.minFilter=ot;Na.magFilter=ot;Na.format=Mr;const Hh=new en({map:Na,side:jt}),Tx=new vi(65,40),Rn=new ft(Tx,Hh);Rn.position.set(190,-60,10);Rn.userData.originalColor=Hh.color.clone();Rn.userData={isImagePlane:!0,isVideoPlane:!0,name:"Nothing Changes",imageSrc:"",description:"A contemplative stop-motion piece exploring the quiet persistence of time and repetition.",medium:"Stop-motion painting",year:"2020"};Ut.add(Rn);ei.push(Rn);br.push(Rn);xi.push(Rn);Rn.userData.ytVideoId="Ytul_pgGHfI";Rn.userData.baseScale=Rn.scale.clone();function Fa({src:i,name:e,description:t,medium:n,year:s,size:r,position:a}){const o=Sx.load(i),l=new en({map:o,side:jt}),c=new vi(...r),u=new ft(c,l);u.position.set(...a),u.userData.originalColor=l.color.clone();const h={isImagePlane:!0,name:e,imageSrc:i,description:t,medium:n,year:s};return u.userData={...u.userData,...h},Ut.add(u),ei.push(u),u}xi.push(wn);const _r=Fa({src:"./yoko.jpg",name:"Yoko",description:"Imagine a 2ft x 3ft canvas where a luminous, glossy background sets a vibrant stage for the central subject rendered in a subtle matte finish. The deliberate contrast creates a dynamic interplay of texture and depth, drawing your eye into the heart of the scene. At the center of this artistic dialogue is a personal homage to my beloved dog Yoko—a gentle reminder of her ever-present warmth and joyful spirit. Yoko’s playful eyes and comforting presence are subtly integrated into the composition, imbuing the painting with both visual intrigue and heartfelt sentiment.",medium:"Acrylic on canvas.",year:"2019",size:[20,40],position:[80,60,75]});xi.push(_r);const vr=Fa({src:"./yoko2.jpg",name:"Yoko",description:"This piece is a colored lithophane made from cast porcelain. It was created using a mold made from a 3D-printed lithophane, from a photograph of my cat, Yoko. A handmade wooden frame encases the lithophane, while colored transparencies add color to the lithophane.</br>The labor-intensive process of making this piece reflects the care and devotion we have for our pets. When illuminated, the lithophane symbolizes how our pets brighten our lives, transforming effort into warmth, labor into love.",medium:"Porcelain and wood",year:"2025",size:[40,40],position:[-105,70,-75]});xi.push(vr);const xr=Fa({src:"./afeeling.jpg",name:"A Feeling",description:"This work features three wood-fired ceramic pieces arranged within a diorama, integrated seamlessly into the scene",medium:"Stoneware, Installation",year:"2024",size:[80,40],position:[-105,-80,-85]});xi.push(xr);const yr=Fa({src:"./owned2.png",name:"Poppified",description:"The main subject was photographed against a green screen and printed. The print was then collaged with traditional painting on canvas. The piece was finally scanned and digitally manipulated to complete the composition.",medium:"Mixed Media",year:"2017",size:[40,40],position:[90,110,-85]});xi.push(yr);function bx(i,e=1.2){const t=new Cn().setFromObject(i),n=new P,s=new P;t.getSize(n),t.getCenter(s),n.multiplyScalar(e);const r=new zs(n.x,n.y,n.z),a=new en({color:16711935,transparent:!0,opacity:0,depthWrite:!1}),o=new ft(r,a);o.name="hitbox",i.worldToLocal(s),o.position.copy(s),i.add(o),o.userData={...i.userData,linkedModel:i,modelRef:i},ei.push(o),o.userData.disableOutline=!0}function yi(i,e,t,n,s=()=>{}){Rh.load(i,r=>{const a=r.scene;a.scale.set(...e),a.position.set(...t),yx(a,n),Ut.add(a),ei.push(a),un.push(a),a.userData.baseScale=a.scale.clone(),bx(a,3.5),s(a)})}let ys,_n,Ii,Ui,ms,Ni,rr,gs;yi("./aartink.glb",[.3,.3,.3],[0,45,0],{isImagePlane:!0,name:"aart.ink",imageSrc:"",description:"",medium:""},i=>{ys=i;const e=document.createElement("video");e.src="./static.mp4",e.loop=!0,e.muted=!0,e.play().catch(()=>{});const t=new Ra(e);t.minFilter=ot,t.magFilter=ot,t.format=Mr,ys.traverse(n=>{n.isMesh&&(n.material.map=t,n.material.needsUpdate=!0)})});yi("./abtahi.glb",[.3,.3,.3],[0,-45,0],{isImagePlane:!0,name:"Abtahi",imageSrc:"./abtahi.jpg",description:"My practice is a conversation between cultures, technologies, and material forms. I move fluidly across ceramics, painting, digital media, sound, and sculpture; drawing from each to build immersive installations that are both sensory and conceptual. Whether projecting real-time visuals onto a floating sphere or handcrafted porcelain lithophanes, I explore how narratives can translate across media and space. At the heart of my work is a desire to transform interaction into meaning, inviting viewers to not just witness; but participate..",medium:""},i=>{_n=i,_n.traverse(t=>{t.isMesh&&t.name!=="hitbox"&&(t.material=new qi({color:16776960,emissive:16776960,emissiveIntensity:1.5,roughness:.3,metalness:.6}))});function e(){_n.traverse(t=>{if(t.isMesh){const n=Math.random();n<.01?t.material.emissiveIntensity=Math.random()*5:n<.3?t.material.emissiveIntensity=Math.random()*2:t.material.emissiveIntensity=.9}})}setInterval(e,Math.random()*200+100)});yi("./barn.glb",[8,8,8],[75,0,-210],{isImagePlane:!0,name:"Texture Map",imageSrc:"",description:"A sculpture that replicates the procedural logic of digital 3D modeling and texture mapping, but constructed entirely through analog, hand-based techniques.",medium:"Sculpture",year:"2023",isVideoPlane:!1,kiriEmbed:`
    <iframe 
      title="Texture Map" 
  ...
  `},i=>{rr=i});yi("./Aphrodite.glb",[10,10,10],[-20,100,-150],{isImagePlane:!0,name:"Aphrodite",imageSrc:"",description:"A woodfired ceramic vessel. Its surface bears the unpredictable blush of flame and ash.",medium:"Stoneware",year:"2022",isVideoPlane:!1,ytVideoId:"",kiriEmbed:`
    <iframe 
      title="Aphrodite" 
  ...
  `},i=>{Ni=i});yi("./face.glb",[10,10,10],[90,-90,-90],{isImagePlane:!0,name:"3D Scan",imageSrc:"",description:"Thats me!",medium:"",year:"2024"},i=>{Ii=i});yi("./pot.glb",[10,10,10],[-80,80,90],{isImagePlane:!0,name:"Bisque Pot",imageSrc:"",description:"Marbled slip cast. Cone 06 bisqued",medium:"Bisqueware",year:"2024"},i=>{Ui=i});const $l=new Wn;Ut.add($l);const Ax=2e3,Nu=900;for(let i=0;i<Ax;i++){const e=new P(Be.randFloatSpread(1),Be.randFloatSpread(1),Be.randFloatSpread(1)).normalize(),t=Math.pow(Math.random(),1.5)*Nu,n=e.multiplyScalar(t),s=Be.mapLinear(t,0,Nu,.1,.5),r=new Xi(s,12,12),a=Be.randFloat(0,1),o=Be.randFloat(.05,.2),l=Be.randFloat(.85,1),c=new _e().setHSL(a,o,l),u=new qi({color:c,emissive:c,emissiveIntensity:Be.randFloat(1,2)}),h=new ft(r,u);h.position.copy(n),$l.add(h)}const Ml=new Wn;Ut.add(Ml);const Sl=[],wx=10;function Rx(){const i=[new _e(7838122),new _e(10070715),new _e(8952234),new _e(6715272),new _e(10079436),new _e(9060914)],e=i[Math.floor(Math.random()*i.length)],t=Be.randFloat(.3,.6),n=new ft(new Xi(t,16,16),new qi({color:e,emissive:e,emissiveIntensity:2,transparent:!0,opacity:0})),s=70,r=[];for(let l=0;l<s;l++){const c=1-l/s,u=new ft(new vi(t*.4,t*1.2),new en({color:e.clone().multiplyScalar(.8),transparent:!0,opacity:c,side:jt,depthWrite:!1,blending:bo}));u.rotation.z=Math.random()*Math.PI,Ml.add(u),r.push(u)}const a=new P(Be.randFloatSpread(300),Be.randFloatSpread(300),Be.randFloatSpread(300)),o=new P(Be.randFloat(.2,.6),Be.randFloat(.1,.4),Be.randFloat(.4,1));n.position.copy(a),Ml.add(n),Sl.push({comet:n,trail:r,velocity:o,curvePhase:Math.random()*Math.PI*2,waveFreq:Math.random()*.5+.2,fadePhase:Math.random()*Math.PI*2})}for(let i=0;i<wx;i++)Rx();function Cx(i,e,t){const n=[],s=Math.PI*2/i;for(let r=0;r<i;r++){const a=r*s+Math.random()*s,o=Be.randFloat(e[0],e[1]),l=Math.cos(a)*o,c=Be.randFloat(t[0],t[1]),u=Math.sin(a)*o;n.push(new P(l,c,u))}return n.push(n[0].clone()),n}function Fu(i,e){const t=i.length-1,n=e%t,s=Math.floor(n),r=n-s;return new P().lerpVectors(i[s],i[(s+1)%i.length],r)}const Vh=[],Px=[{url:"./stop.glb",scale:.5},{url:"./whisper.glb",scale:.5},{url:"./clayman.glb",scale:.5},{url:"./orloff.glb",scale:.1},{url:"./interdis.glb",scale:.3},{url:"./coffee.glb",scale:.6},{url:"./hydrant.glb",scale:.6},{url:"./GKmodel.glb",scale:.6}];Px.forEach(({url:i,scale:e})=>{Rh.load(i,t=>{const n=t.scene;n.scale.set(e,e,e);const s=Cx(10,[50,180],[-100,100]);n.userData={path:s,offset:Math.random()*10,baseScale:new P(e,e,e),speed:.1+Math.random()*.05,currentIntensity:0,trail:[],trailLength:200};for(let r=0;r<n.userData.trailLength;r++){const a=new ft(new Xi(n.scale.x*1.2,8,8),new qi({color:new _e().setHSL(r/n.userData.trailLength,1,.5),emissive:new _e().setHSL(r/n.userData.trailLength,1,.5),emissiveIntensity:1.5,transparent:!0,opacity:0}));Ut.add(a),n.userData.trail.push(a)}Vh.push(n),un.push(n),Ut.add(n)})});const fi=new mp(16777215,2);Ut.add(fi);const Gh=new vh(16777215,1);Gh.position.set(1,1,1).normalize();Ut.add(Gh);const ct={w:!1,a:!1,s:!1,d:!1,q:!1,e:!1,arrowup:!1,arrowdown:!1,arrowleft:!1,arrowright:!1,shift:!1,control:!1," ":!1};window.addEventListener("blur",()=>{for(const i in ct)ct[i]=!1});document.addEventListener("visibilitychange",()=>{if(document.hidden)for(const i in ct)ct[i]=!1});window.addEventListener("keydown",i=>{const e=i.key.toLowerCase();e in ct&&(ct[e]=!0),i.code==="Space"&&(ct[" "]=!0)});window.addEventListener("keyup",i=>{const e=i.key.toLowerCase();e in ct&&(ct[e]=!1),i.code==="Space"&&(ct[" "]=!1)});function Wh(){const i=document.querySelector(".welcome-popup"),e=document.getElementById("interaction-catcher");return(i==null?void 0:i.classList.contains("visible"))||!!e}function Lx(i){if(!Wh()&&!(!i.geometry||i.getObjectByName("outline")))if(i.userData.cachedOutline){const e=i.userData.cachedOutline.clone();e.name="outline",i.add(e)}else{const e=new jf(i.geometry),t=new zl({color:16776960}),n=new hh(e,t);n.name="outline",i.add(n),i.userData.cachedOutline=n.clone()}}function Xh(i){Wh()||i.userData.disableOutline||(i.isMesh&&Lx(i),i.children.forEach(Xh))}function El(i){const e=i.getObjectByName("outline");e&&i.remove(e),i.children.forEach(El)}window.addEventListener("mousemove",i=>{const e=Ue.classList.contains("active"),t=document.querySelector(".welcome-popup"),n=document.getElementById("interaction-catcher"),s=(t==null?void 0:t.classList.contains("visible"))||!!n;if(e||s){hi.classList.remove("visible");return}As.x=i.clientX/window.innerWidth*2-1,As.y=-(i.clientY/window.innerHeight)*2+1,Fs.setFromCamera(As,dt);const r=Fs.intersectObjects(ei,!0);let a=!1;for(const o of r)if(o.object.userData.isImagePlane){let l=o.object;l.userData.linkedModel&&(l=l.userData.linkedModel),hi.classList.add("visible"),hi.style.left=`${i.clientX+10}px`,hi.style.top=`${i.clientY+10}px`,hi.innerHTML=l.userData.name,li!==l&&(li&&El(li),Xh(l),li=l),a=!0;break}a||(hi.classList.remove("visible"),li&&(El(li),li=null))});const Ou=Ws?"Touch to play music":"Click to play music";window.addEventListener("load",()=>{const i=document.createElement("div");i.className="welcome-popup",i.innerHTML=`
      <div class="welcome-content">
        <h2 data-text="AART.INK">AART.INK</h2>
        <p data-text="${Ou}">${Ou}</p>
      </div>
    `,document.body.appendChild(i)});function Jl(){const i=document.querySelector(".welcome-popup");i&&(i.classList.remove("visible"),i.classList.add("closing"),setTimeout(()=>{i.remove()},800))}window.addEventListener("load",()=>{if(/Mobi|Android/i.test(navigator.userAgent)){const e=document.createElement("div");e.id="interaction-catcher",e.style.position="fixed",e.style.top="0",e.style.left="0",e.style.width="100vw",e.style.height="100vh",e.style.zIndex="9999",e.style.background="transparent",e.style.pointerEvents="auto",document.body.appendChild(e);const t=()=>{var n;if(!(Os||La)){Os=!0,rt.load(),e.remove();try{const s=new(window.AudioContext||window.webkitAudioContext);(n=s.resume)==null||n.call(s)}catch{}rt.play().then(()=>{console.log("🎧 Ambient started via interaction catcher"),Jl(),setupVolumeUI()}).catch(s=>{console.warn("❌ Autoplay failed:",s),alert("⚠️ Tap again to enable audio")})}};e.addEventListener("click",t,{once:!0}),e.addEventListener("touchstart",t,{once:!0})}});window.addEventListener("click",i=>{var h;if(La){i.preventDefault(),i.stopPropagation();return}document.getElementById("interaction-catcher")&&((h=document.getElementById("interaction-catcher"))==null||h.remove());const e=Date.now();if(e-Du<cx)return;Du=e;const t=Math.abs(i.clientX-((Vt==null?void 0:Vt.x)??0)),n=Math.abs(i.clientY-((Vt==null?void 0:Vt.y)??0));if(t>Ta||n>Ta||Er!==i.target){console.log("❌ Dragged-in click blocked");return}if(i.target.closest(".welcome-popup, .mic-popup, .modal, #interaction-catcher, .volume-control, .unmute-btn")||document.body.classList.contains("mic-blocking")||Zt.style.display==="flex"&&i.target.closest(".mic-popup-window")||Zt.style.display==="flex")return;const a=Ue.classList.contains("active"),o=i.target.closest(".modal-close"),l=i.target.closest(".modal-content"),c=i.target.closest(".modal-overlay");if(a){(o||!l&&c)&&gr();return}if(document.getElementById("scene-wrapper").classList.contains("blocked"))return;Fs.setFromCamera(As,dt);const u=Fs.intersectObjects(ei,!0);for(const d of u)if(d.object.userData.isImagePlane){const{name:p,imageSrc:g,medium:_,year:m,description:f,isVideoPlane:E,ytVideoId:T,kiriEmbed:M}=d.object.userData;setTimeout(()=>{Bh({name:p,imageSrc:g,medium:_,year:m,description:f,isVideoPlane:E,ytVideoId:T,kiriEmbed:M})},0);break}});function Bs(){const i=document.querySelector(".modal-details");if(!i)return;const e=i.scrollTop,t=i.scrollHeight,n=i.clientHeight,s=e===0,r=e+n>=t-1;i.classList.toggle("at-top",s),i.classList.toggle("at-bottom",r),i.classList.toggle("at-top-at-bottom",s&&r),s&&r?i.classList.add("at-top-at-bottom"):i.classList.remove("at-top-at-bottom")}document.addEventListener("DOMContentLoaded",Bs);window.addEventListener("resize",Bs);var ku;(ku=Ue.querySelector(".modal-details"))==null||ku.addEventListener("scroll",Bs);function Dx(){const e=document.createElement("canvas");e.width=e.height=512;const t=e.getContext("2d"),n=["#ff00ff","#00ffff","#ffff00","#ff8800","#00ff88"];for(let r=0;r<10;r++){const a=Math.random()*512,o=Math.random()*512,l=Math.random()*80+40,c=n[Math.floor(Math.random()*n.length)];for(let u=-1;u<=1;u++)for(let h=-1;h<=1;h++){const d=a+u*512,p=o+h*512,g=t.createRadialGradient(d,p,0,d,p,l);g.addColorStop(0,c),g.addColorStop(1,"transparent"),t.fillStyle=g,t.beginPath(),t.arc(d,p,l,0,Math.PI*2),t.fill()}}const s=new Yf(e);return s.wrapS=s.wrapT=ki,s.repeat.set(2,2),s.needsUpdate=!0,s}const Tl=Dx(),ci={nebulaTex:{value:Tl},opacity:{value:0},hueShift:{value:0},time:{value:0}},lr=new ft(new Xi(1e3,64,64),new Kn({uniforms:ci,vertexShader:`
      varying vec2 vUV;
      void main() {
        vUV = uv;
    ...
    `,side:Gt,transparent:!0,depthWrite:!1}));Ut.add(lr);let Ql=!1,kt=!1,zt,Ke,la=10;const _t=document.getElementById("sound-toggle"),Zt=document.createElement("div");Zt.id="mic-popup";Zt.className="mic-popup";Zt.innerHTML=`
  ...
  `;document.body.appendChild(Zt);document.addEventListener("keydown",i=>{i.key==="Escape"&&Zt.style.display==="flex"&&ws()});document.body.appendChild(Zt);Nx();function Ix(){Ql||(_t.innerHTML='<i class="fas fa-microphone"></i>',_t.title="Enable mic",setTimeout(()=>{const i=document.createElement("span");i.className="mic-hint";const e="DISCO MODE";i.innerHTML=[...e].map((t,n)=>`<span class="rainbow-letter" style="--i:${n}">${t===" "?"&nbsp;":t}</span>`).join(""),_t.appendChild(i),requestAnimationFrame(()=>_t.classList.add("reveal")),setTimeout(()=>{i.classList.add("fade-out"),_t.classList.remove("reveal"),setTimeout(()=>i.remove(),300),document.querySelector(".volume-control").classList.add("hover-ready")},15e3)},3e3),_t.style.display="flex",_t.classList.add("visible","fade-in"),setTimeout(()=>_t.classList.remove("fade-in"),500),setTimeout(()=>{_t.classList.remove("visible"),_t.classList.add("low-opacity");const i=document.querySelector(".volume-control");i.classList.remove("hover-ready"),i.classList.add("low-opacity")},18e3))}window.addEventListener("volumePulseFinished",Ix);_t.addEventListener("click",()=>{Ql?(kt=!kt,kt?(_t.classList.remove("low-opacity"),_t.classList.add("enabled"),_t.title="Disable mic",_t.innerHTML='<i class="fas fa-microphone"></i>'):(_t.classList.remove("enabled"),_t.classList.add("low-opacity"),_t.title="Enable mic",_t.innerHTML='<i class="fas fa-microphone"></i>',setTimeout(Fx,500))):Ux()});function Ux(){var i,e;Zt.style.display="flex",document.body.classList.add("mic-blocking"),(i=document.getElementById("scene-wrapper"))==null||i.classList.add("blocked"),(e=document.getElementById("touch-blocker"))==null||e.style.setProperty("display","block")}function ws(){var i,e;Zt.style.display="none",document.body.classList.remove("mic-blocking"),(i=document.getElementById("scene-wrapper"))==null||i.classList.remove("blocked"),(e=document.getElementById("touch-blocker"))==null||e.style.setProperty("display","none")}function Nx(){const i=document.getElementById("enable-mic-btn"),e=document.getElementById("deny-mic-btn");if(!i||!e){console.warn("Mic buttons not found yet");return}i.addEventListener("click",async()=>{i.disabled=!0,i.textContent="Enabling...";try{const t=await navigator.mediaDevices.getUserMedia({audio:!0}),n=new(window.AudioContext||window.webkitAudioContext);await n.resume();const s=n.createMediaStreamSource(t);zt=n.createAnalyser(),zt.fftSize=256,Ke=new Uint8Array(zt.frequencyBinCount),s.connect(zt),Ql=!0,kt=!0,ws(),_t.title="Disable Mic",_t.classList.remove("low-opacity"),_t.classList.add("enabled")}catch(t){console.error("Mic error:",t),alert("Microphone access denied or not supported."),ws()}finally{i.disabled=!1,i.textContent=`Yep
let’s vibe!`}}),e.addEventListener("click",t=>{t.stopPropagation(),ws()})}var zu;(zu=document.getElementById("deny-mic-btn"))==null||zu.addEventListener("click",i=>{i.stopPropagation(),ws()});window.addEventListener("click",i=>{const e=Zt.style.display==="flex",t=i.target.closest(".mic-popup-window"),n=i.target.closest("#sound-toggle");e&&!t&&!n&&ws()});function Fx(){lr.material.opacity=0,fi.intensity=2,fi.color.set(16777215),_n&&_n.traverse(i=>{i.isMesh&&i.material&&(Array.isArray(i.material)?i.material:[i.material]).forEach(t=>{var n,s;(n=t.color)==null||n.set(2236928),(s=t.emissive)==null||s.set(16776960),t.emissiveIntensity=1.5,t.metalness=.3,t.roughness=.8,t.needsUpdate=!0})}),xt!=null&&xt.material&&xt.material.color.set(16777215),[_r,vr,xr,yr].forEach(i=>{i!=null&&i.material&&i.userData.originalColor&&i.material.color.copy(i.userData.originalColor)})}let tr=1;const Bu=new _e(16777215);un.push(xt);xt.userData.baseScale=xt.scale.clone();un.push(...xi);un.push(...br);_r.userData.baseScale=_r.scale.clone();vr.userData.baseScale=vr.scale.clone();xr.userData.baseScale=xr.scale.clone();yr.userData.baseScale=yr.scale.clone();un=un.filter(i=>{var e;return((e=i==null?void 0:i.userData)==null?void 0:e.baseScale)instanceof P});const ps={aart:{amplitude:1.2,speed:.6,offset:.5},abtahi:{amplitude:1.4,speed:.7,offset:2.2}};function qh(){var l;requestAnimationFrame(qh),xx(Vi)&&(dt.aspect=Bi.clientWidth/Bi.clientHeight,dt.updateProjectionMatrix());const i=performance.now()*.001,e=.35,t=ct.shift?e*3:e,n=new P,s=new P,r=new P,a=new P(0,1,0);if(dt.getWorldDirection(s),s.y=0,s.normalize(),r.crossVectors(s,dt.up).normalize(),a.set(0,1,0),n.set(0,0,0),(ct.w||ct.arrowup)&&n.add(s),(ct.s||ct.arrowdown)&&n.sub(s),(ct.d||ct.arrowright)&&n.add(r),(ct.a||ct.arrowleft)&&n.sub(r),ct[" "]&&n.add(a),ct.control&&n.sub(a),n.normalize().multiplyScalar(t),dt.position.add(n),Dt&&(ct.q||ct.e)){const u=ct.shift?5:2,h=dt.position.distanceTo(Dt.target),d=u*h/500,p=new P;dt.getWorldDirection(p),p.y=0,p.normalize(),p.cross(dt.up).normalize();const g=p.clone().multiplyScalar(ct.q?-d:d);Dt.target.add(g),dt.position.add(g)}if(zt&&Ke&&kt?(zt.getByteFrequencyData(Ke),un.forEach((c,u)=>{var _;if(!((_=c.userData)!=null&&_.baseScale))return;const h=u%Ke.length,d=Ke[h]/255,p=Be.lerp(1,1.25,d),g=c.userData.baseScale.clone().multiplyScalar(p);c.scale.lerp(g,.15)})):un.forEach(c=>{var u;(u=c.userData)!=null&&u.baseScale&&c.scale.lerp(c.userData.baseScale,.15)}),zt&&Ke){zt.getByteFrequencyData(Ke);const c=Ke.reduce((I,O)=>I+O,0)/Ke.length;if(zt&&Ke){zt.getByteFrequencyData(Ke);const I=Ke.reduce((O,G)=>O+G,0)/Ke.length;la+=(I-la)*.05}tr+=((kt?1:0)-tr)*.03;const h=Ke.slice(0,20).reduce((I,O)=>I+O,0)/20||0,d=Ke.slice(20,100).reduce((I,O)=>I+O,0)/80||0,p=Ke.slice(100).reduce((I,O)=>I+O,0)/Math.max(1,Ke.length-100),g=(h+d+p)/3,f=Be.lerp(5e-5,2e-4,g/200),E=performance.now()*f%1,T=Be.clamp((h-p+128)/255,0,1),M=(E+T*.05)%1,D=Be.lerp(.3,.6,la/255),R=new _e().setHSL(M,1,D);kt&&Bu.copy(R);const A=new _e().setHSL(.58,.2,.8).clone().lerp(Bu,tr);if(zt&&Ke&&kt){zt.getByteFrequencyData(Ke);const I=Ke.slice(0,8).reduce((G,z)=>G+z,0)/8,O=Be.clamp(I/255,0,1);un.forEach((G,z)=>{var Ee;if(!((Ee=G.userData)!=null&&Ee.baseScale))return;const j=z%Ke.length,W=Ke[j]/255,ee=Be.lerp(1.25,1.55,O),ne=Be.lerp(1,ee,W),ge=G.userData.baseScale.clone().multiplyScalar(ne);G.scale.lerp(ge,.2)})}else un.forEach(I=>{var O;(O=I.userData)!=null&&O.baseScale&&I.scale.lerp(I.userData.baseScale,.15)});const S=Ke.slice(0,8).reduce((I,O)=>I+O,0)/8,x=Ke.slice(-12).reduce((I,O)=>I+O,0)/12,C=Be.clamp((S+x)/2/255,0,1);if(ci.hueShift.value+=C*.02,fi.intensity=Be.lerp(fi.intensity,3.5+C*4,.12),C>.6&&(dt.position.x+=Math.sin(i*30)*.5*C,dt.position.y+=Math.cos(i*30)*.5*C),ci){const I=kt?Be.clamp(c/90,.2,.7):0;ci.opacity.value+=(I-ci.opacity.value)*.05;const G=1e-4+(Ke.slice(0,10).reduce((z,j)=>z+j,0)/10||0)/25500;ci.hueShift.value=(ci.hueShift.value+G)%1}fi.color.lerp(A,.15),fi.intensity=Be.lerp(fi.intensity,3+tr*2,.1),kt&&_n&&_n.traverse(I=>{var O;I.isMesh&&((O=I.material)!=null&&O.emissive)&&(I.material.emissive.lerp(A,.05),I.material.emissiveIntensity=Be.lerp(I.material.emissiveIntensity||1.5,1.5+la/255*tr,.05))}),[...br,_r,vr,xr,yr].forEach(I=>{var O;(O=I.material)!=null&&O.color&&I.material.color.lerp(A,.1)}),(l=xt==null?void 0:xt.material)!=null&&l.color&&xt.material.color.lerp(A,.1)}if(xt&&(xt.rotation.y+=.001,xt.rotation.x+=6e-4,xt.rotation.z+=8e-4,xt.position.y=Math.sin(i*.7+1.2)*1.5,xt.position.x=Math.sin(i*(.7*.8)+.5)*(1.5*.5),xt.position.z=Math.sin(i*(.7*1.3)+2.4)*(1.5*.3)),$n.readyState===$n.HAVE_ENOUGH_DATA&&(kh.needsUpdate=!0),xi.forEach((c,u)=>{if(li!==c){const h=u%2===0?1:-1;c.rotation.y+=5e-4*h,c.rotation.z+=5e-4*-h}}),ys&&(ys.rotation.y+=-4e-4),_n&&(_n.rotation.y+=7e-4),Ii&&(Ii.rotation.y+=.001),Ii&&(Ii.rotation.x+=.001),Ii&&(Ii.rotation.z+=.001),Ui&&(Ui.rotation.y+=.001),Ui&&(Ui.rotation.x+=.001),Ui&&(Ui.rotation.z+=.001),Tl&&(Tl.offset.x+=5e-4),ms){ms.rotation.y+=.001,ms.rotation.x+=6e-4,ms.rotation.z+=8e-4;const c=i*.7+1.5;ms.position.y=120+Math.sin(c)*1.3}if(Ni){Ni.rotation.y+=.001,Ni.rotation.x+=.0012,Ni.rotation.z+=5e-4;const c=i*.5+2.2;Ni.position.y=-60+Math.sin(c)*1.4}if(rr){Ni.rotation.y+=.001,rr.rotation.x+=7e-4,rr.rotation.z+=5e-4;const c=i*.6+1.8;rr.position.y=-10+Math.sin(c)*1.5}if(gs){gs.rotation.y+=.001,gs.rotation.x+=7e-4,gs.rotation.z+=5e-4;const c=i*.6+1.8;gs.position.y=-10+Math.sin(c)*1.5}if(ys){const c=i*ps.aart.speed+ps.aart.offset;ys.position.y=45+Math.sin(c)*ps.aart.amplitude}if(_n){const c=i*ps.abtahi.speed+ps.abtahi.offset;_n.position.y=-45+Math.sin(c)*ps.abtahi.amplitude}const o=performance.now()*.001;Vh.forEach((c,u)=>{const{path:h,offset:d,speed:p,baseScale:g,trail:_}=c.userData,m=o*(p*(kt?4:.5))+d,f=Fu(h,m),E=Fu(h,m+.05);let T=0;kt&&zt&&Ke&&(zt.getByteFrequencyData(Ke),T=Ke[u%Ke.length]/255),c.userData.currentIntensity+=(T-c.userData.currentIntensity)*.05;const M=c.userData.currentIntensity,D=new P(Math.sin(m*1.1+d)*(3+M*2),Math.sin(m*1.6+d)*(8+M*4),Math.cos(m*1.3+d)*(3+M*2));let R;if(kt?(R=f.clone().add(D).clamp(new P(-200,-200,-200),new P(200,200,200)),c.userData.lastPosition=R.clone()):R=c.userData.lastPosition||c.position.clone(),c.position.lerp(R,.1),kt){const A=E.clone().sub(f).normalize(),S=new yn().setFromUnitVectors(new P(0,0,1),A);c.quaternion.slerp(S,.08)}c.rotation.x+=Math.sin(m+d)*.002,c.rotation.y+=Math.cos(m*.8+d)*.002;const w=Be.lerp(1,1.3,M);c.scale.lerp(g.clone().multiplyScalar(w),.08);for(let A=_.length-1;A>0;A--)_[A].position.lerp(_[A-1].position,.5),_[A].material.opacity=Be.lerp(_[A].material.opacity,_[A-1].material.opacity,1),_[A].material.emissiveIntensity*=.9;if(_[0].position.copy(c.position),kt&&zt&&Ke){const S=Ke.reduce((V,I)=>V+I,0)/Ke.length/255,x=(performance.now()*2e-4+S*.5)%1,C=new _e().setHSL(x,1,.5);_[0].material.color.copy(C),_[0].material.emissive.copy(C),_[0].material.opacity=Be.lerp(0,.9,S),_[0].material.emissiveIntensity=Be.lerp(.5,3,S)}else _[0].material.opacity*=.9,_[0].material.emissiveIntensity*=.9}),$l.rotation.y=Math.sin(i*.05)*.2;for(let c=0;c<Sl.length;c++){const{comet:u,velocity:h,trail:d,curvePhase:p,waveFreq:g,fadePhase:_}=Sl[c],m=i*g+p,f=new P(Math.sin(m*1.5)*.2,Math.cos(m*1.2)*.2,Math.sin(m)*.1),E=h.clone().add(f);u.position.add(E),u.rotation.y+=.01;const T=.6+.3*Math.sin(i*1.8+_),M=Math.sin((i+_)*.3)*.2,D=Math.max(.25,T+M);u.material.opacity=D,u.position.length()>600&&u.position.set(Be.randFloatSpread(300),Be.randFloatSpread(300),Be.randFloatSpread(300));for(let R=d.length-1;R>0;R--){d[R].position.copy(d[R-1].position);const w=Math.sqrt(1-R/d.length);d[R].material.opacity=w*D}d[0].position.copy(u.position),d[0].material.opacity=D}lr.rotation.x=Math.sin(i*.12)*.2,lr.rotation.y=Math.cos(i*.1)*.3,lr.rotation.z=Math.sin(i*.15)*.25,ci.time.value=i*2,Ut.rotation.y+=25e-5,mx(),Dt.update(),Vi.render(Ut,dt)}qh();const Ox=[document.querySelector("video"),Jn,Qn,rt],Bx=Ox.map(i=>new Promise(e=>{if(!i)return e();const t=()=>e();i.readyState>=3?t():i instanceof HTMLAudioElement||i instanceof HTMLVideoElement?(i.addEventListener("canplaythrough",t,{once:!0}),i.load()):t()}));
